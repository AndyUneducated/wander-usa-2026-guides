module.exports = {
  ...
  navName: 'Brooklyn',
  color: '#4da3ff',
  lead: '这一区的价值在于「同一条河的另一侧」：Manhattan 的天际线在这里是<strong>被拍摄对象</strong>而不是你站的地方，' +
    '而且八个点位里有六个完全免费。但整区的成败几乎只由一件事决定——<strong>秋色时间</strong>。' +
    ...
    '2026 年秋天只是在做环评听证）；<strong>Coney Island 两家游乐场都还在营业</strong>，' +
    'Deno\u2019s Wonder Wheel 的 2026 赛季末日是 <strong>10 月 25 日</strong>——但只在周末与犹太节日开，日期表必须逐日对。' +
  ...
  callouts: [
    {
      ...
      html: '<p>纽约市是全州最晚变色的地方，原因是<strong>城市热岛效应把物候整体往后推</strong>，加上临海气温缓冲。' +
        ...
        '去了只能当公园逛，拍不到秋色；10 月 20 日–11 月 5 日才是真窗口；' +
        '10 月 22 日恰好踩在预报峰值的第一两天上，是本行程窗口内唯一站得住的秋色日期。</strong>' +
    ...
    },
    {
      ...
      html: '<p><strong>先排除一个变量：2026 年夏令时结束于 11 月 1 日，落在本行程窗口之外</strong>，' +
  ...
  spots: [
    ...
    },
    {
      ...
      access: {
        ...
        hours: '<strong>24 小时可拍</strong>。但实际可用窗口由人流决定，不由时间决定：' +
          '<strong>日出前到 07:00 街上通常只有个位数的人、经常完全空无一人；' +
          '09:00 之后属「极度拥挤」；10:00–18:00 全天高峰，周末尤甚，' +
          '同一帧会有一条明显的排队队列，周末可以排一小时</strong>。' +
    ...
    },
    {
      ...
      access: {
        book: '不需预约',
        ticket: '<strong>免费</strong>',
        hours: '<strong>24 小时开放，全年无休。</strong>它法律上不是公园（产权属 NYC DOT），' +
          '因此不适用市属公园的 06:00–01:00 关门规定。' +
          '<strong>2026 年秋季无任何封闭</strong>——BQE Central 大修 2030 年才破土。' +
    ...
    },
    {
      ...
      access: {
        book: '<strong>建议线上预购但非强制</strong>。官方口径：advance tickets are recommended，' +
          ...
          '票不可退，但可提前换日期',
        ticket: '成人现场 <strong>$22</strong>／线上 $23.67（含 $1.67 手续费）；' +
          '65 岁以上与 12 岁以上持证学生现场 <strong>$16</strong>／线上 $17.47；' +
          '<strong>12 岁以下免费</strong>（14 岁以下须 18 岁以上成人陪同）。' +
          '另有 <strong>Museum &amp; Garden 联票</strong>（含隔壁 Brooklyn Museum 当日入场）：' +
          '成人现场 $34／线上 $36.06，65+ 与 20 岁以上学生 $24，12–19 岁学生 $16——' +
          '注意 <strong>Brooklyn Museum 周二闭馆</strong>，联票须同日使用。' +
          '每日另有一定数量免费的 Community tickets',
        hours: '<strong>9 月：周二至周四 10:00–19:00；周五至周日 10:00–18:00；周一闭馆。</strong>' +
          '<strong>10 月：周二至周日 10:00–18:00；周一闭馆，' +
          '但 10 月 12 日（Indigenous Peoples\u2019 Day）例外开放 10:00–18:00。</strong>' +
          '<strong>末次入园为闭园前 30 分钟；专类园（含 Japanese Hill-and-Pond Garden 与温室）' +
          '在闭园前 30 分钟开始清园。</strong>' +
          '<strong>10 月 24 日（周六）为 Fall Harvest Festival，需专门票，当天不售普通门票。</strong>' +
          '会员另有 Fall Mornings 提前入园：周六日 09:00–10:00（9 月 12 日起）。' +
          '<strong>以上全部于 2026 年 9 月 6 日在 bbg.org/visit/hours 逐行复核，与官网现行口径一致。</strong>' +
          '<strong>落到真实日期：10/16 周五、10/17 周六、10/18 周日三天都开，都是 10:00–18:00，' +
          '不碰周一闭馆、也不碰 10/24 的 Fall Harvest Festival。' +
          '但要按 18:00 关门倒推着安排：末次入园 17:30，而且 Japanese Hill-and-Pond Garden 这类专类园' +
          '同样从 17:30 开始清园——也就是说主角景点你最晚 17:25 就得站在里面。' +
          '当天日落是 18:11–18:14，全都在闭园之后，' +
          '所以这里从一开始就不是日落机位，请把它当白天场，日落交给 Prospect Park。</strong>' +
          '<strong>另一件要认的事：本区秋色预报峰值在 10 月 21 日前后，' +
          '10/16–10/18 来大概率还偏绿，见本区第一条提醒。</strong>',
    ...
    },
    {
      ...
      shots: [
        ...
        },
        {
          ...
          desc: '<strong>清晨 07:00–08:30 是唯一正确的时段，而且只在 9 月成立。</strong>' +
            ...
            '问题是<strong>主门 9 月 30 日之前 07:00 开、10 月起（未公布，估计）08:00 开</strong>，' +
            '而 10/22 日出是 07:15——<strong>十月来这里就拿不到晨光了</strong>。' +
      ...
      access: {
        ...
        ticket: '<strong>免费</strong>。官方原文：「We\u2019re open 365 days a year, at no charge.」' +
          '<strong>园内停车也完全免费</strong>',
        hours: '<strong>官网现行公布的是 2026 年 4 月 1 日至 9 月 30 日的时刻表：</strong>' +
          '主门（Fifth Avenue &amp; 25th Street）<strong>每天 07:00–19:00</strong>，车辆与行人皆可；' +
          'Sunset Park 门（Fourth Avenue &amp; 35th Street）行人 08:00–19:00、车辆 08:00–16:00；' +
          'Fort Hamilton Parkway 门与 Prospect Park West 门行人周一至周五 11:00–19:00、周六日 08:00–19:00，' +
          '车辆仅周六日 08:00–16:00。' +
          '<strong>10 月 1 日起的 2026 年秋冬时刻表，2026 年 9 月 6 日再查一轮，官网仍然只挂着上面这份 4/1–9/30 的表，' +
          '10 月之后依旧没有公布——未能从官方渠道确认。</strong>' +
          '（green-wood.com/hours 页四个门全部标注「April 1, 2026 through September 30, 2026」；' +
          'Plan A Visit 页的措辞是「currently open every day from 7am to 7pm」，' +
          '一个「currently」说明他们自己也把这当成会变的临时状态。）' +
          '近年惯例是十月初至十一月初改为 <strong>08:00–18:00</strong>、之后 08:00–17:00。' +
          '<strong>这件事直接决定你能不能拍到日落，而且对真实日期来说是本条目最大的一个未知数：</strong>' +
          '9/25–9/30 期间 19:00 关园、当日日落 18:48–18:40，' +
          '<strong>是本窗口内唯一能在园内拍到完整昏金光的时段</strong>；' +
          '<strong>而真实日期 10/16–10/18 的日落是 18:14／18:12／18:11，' +
          '正好卡在两种可能的闭园钟点中间——按旧表的 19:00 关，你能从容拍完日落甚至一小段蓝调；' +
          '一旦改成惯例的 18:00 关（加上要求提前 10 分钟离场，实际 17:50 就得往外走），' +
          '你会在日落前二十多分钟被请出去，昏金光只剩一个尾巴，蓝调完全没有。' +
          '备用窗口的 10/22（日落 18:05）同理。</strong>' +
          '<strong>请务必在出发前几天打 (718) 768-7300 或写 contactus@green-wood.com 问准十月的闭园钟点，' +
          '这一个电话决定你要不要为日落专门跑这一趟</strong>；' +
          '若问不到，稳妥办法是<strong>把 Green-Wood 排成下午场（14:00–17:30 的斜光）、' +
          '把日落与蓝调交给同区不受闭园限制的 Prospect Park（05:00–01:00）</strong>。' +
          '园方特别提醒<strong>请在闭园时间前至少 10 分钟离场，闸门准点上锁</strong>' +
          '（被锁在里面请打安保 347-865-4816）。' +
          '园内的 Green-House 游客中心 4/18–9/30 周四至周一 10:00–19:00、周二周三闭，' +
          '联邦假日闭馆（含 Labor Day 与 10 月 12 日 Indigenous Peoples\u2019 Day）',
      ...
      notes: [
        ...
        '<strong>园内道路人车共用</strong>，家属会开车找墓位。' +
          ...
          '架三脚架时请完全离开车道',
        '<strong>十月的闭园钟点是这一站最大的不确定项。</strong>' +
          '出发当天请查 green-wood.com/hours 或打 (718) 768-7300 确认。' +
          '如果确认是 18:00 关，请把行程改到上午，并接受<strong>这一站十月只有平光可用</strong>',
    ...
    },
    {
      ...
      shots: [
        {
          ...
          desc: '<strong>坏消息先说：这个机位在本行程窗口（9/25–10/25）内拍不成，请不要按它排时间。</strong>' +
            'Deno\u2019s 秋季每天 18:00 关园，而窗口内日落是 18:01（10/25）到 18:47（9/25）——' +
            '<strong>蓝调开始时摩天轮已经停了、人也被请出去了。' +
            '真实日期 10/17（日落 18:12）与 10/18（日落 18:11）同样如此，10/16 周五 Deno\u2019s 根本不开园。</strong>' +
      ...
      access: {
        ...
        ticket: '<strong>两家游乐场都是免票入园（Admission is FREE at all times）</strong>，' +
          '设施按次单独计费。Deno\u2019s：<strong>Wonder Wheel 单次 $10</strong>、' +
          'Phoenix $10、Thunderbolt（音乐旋转）$10、Spook-A-Rama $8、碰碰车 $8、' +
          'Stop the Zombies $8、多数儿童设施 $5；' +
          '也可买点数包（$50/60 点、$90/125 点、$125/175 点），现金与信用卡皆可。' +
          'Luna Park 另售当日无限次 Wristband，' +
          '<strong>整季通票的有效期写到 2026 年 11 月 1 日</strong>，' +
          'Halloween Harvest 的活动权益需搭配 Wristband',
        hours: '<strong>木栈道、沙滩与 Parachute Jump 的夜间照明不受游乐场日历限制。</strong>' +
          '<strong>Deno\u2019s Wonder Wheel Park 2026 年营业日（官网逐日日历，本窗口内）：' +
          '9/26–10/1 连续六天、10/3、10/4、10/10、10/11、10/12、10/17、10/18、10/24、10/25</strong>；' +
          '其余日期闭园（<strong>含 9/25 与 10/2 两个周五</strong>），10/25 后至 2027 年无营业日。' +
          '开门：儿童区 11:00、Wonder Wheel 等成人机械 12:00。' +
          '<strong>关园钟点已经查到了，是 18:00，原先本条写的「官网未公布」可以撤销：' +
          'denoswonderwheel.com 的 Hours 页日历里，9 月 8 日夏季档结束之后的每一个营业日都记为 18:00 结束</strong>' +
          '（9/9、9/21、9/29、9/30、10/1、10/12 这些单日条目全是 11:00–18:00，' +
          '各个周末条目也一律以周日 18:00 收尾；作为对照，6/4–9/8 的夏季档结束时间是 22:00）。' +
          '<strong>需要照实说明的两点保留：一是这个 18:00 只出现在日历的结束时刻里，' +
          '页面正文只宣传开门时间、没有用文字写出闭园钟点；' +
          '二是官方原话「Hours are subject to change based on weather and operating conditions」，' +
          '关园钟点仍随天气浮动。当天务必打 (718) 372-2592 核实。</strong>' +
          '<strong>直接后果：10/17 日落 18:12、10/18 日落 18:11，Deno\u2019s 都在日落前就关了——' +
          '摩天轮的蓝调亮灯照拍不到，这不是运气问题，是全季如此。</strong>' +
          '<strong>Luna Park</strong> 的 Halloween Harvest 期间为 9/18–11/1，' +
          '<strong>官网 lunaparknyc.com/plan/park-hours 的活动日历现已展开到 11 月 1 日，10 月逐日钟点为：' +
          '周五 16:00–22:00、周六与周日 11:00–20:00、10/12（Indigenous Peoples\u2019 Day）11:00–20:00、周二至周四闭园；' +
          '10/31（万圣节当天）延长到 11:00–22:00，11/1（周日）11:00–20:00 是本季最后一天（官网标注 Last day of Fall Season）</strong>。' +
          '<strong>注意十月的周六不再像九月那样开到 22:00，而是 20:00——只有周五和万圣节是 22:00 场，这一点原先记错了。</strong>' +
          '<strong>落到真实日期：10/16 周五 16:00–22:00、10/17 周六 11:00–20:00、10/18 周日 11:00–20:00，' +
          '三天全部覆盖日落（18:11–18:14）与民用暮光结束（18:38–18:41）</strong>',
