module.exports = {
  ...
  callouts: [
    ...
    },
    {
      ...
      html: '<p><strong>先记住一件最容易踩的事：Wonder Wheel 和 Cyclone 属于两家不同的公司，日历不一样。</strong>' +
        ...
        'Deno\u2019s 的开门时间是儿童区 11:00、Wonder Wheel 等成人机械 12:00。' +
        '<strong>关园时间随天气浮动，2026 年 10 月的具体闭园钟点官网未公布——未能从官方渠道确认。</strong>' +
        '作为参照，2025 年 10 月的官方口径是儿童区与成人机械都 <strong>18:00 关</strong>；' +
        '若 2026 年照此执行，则 10 月中下旬（10/17 日落 18:13、10/24 日落 18:03）' +
        '<strong>你会在摩天轮灯亮之前就被清场，拍不到蓝调亮灯轮</strong>。当天出发前请打 (718) 372-2592 问实际关园时间。</p>' +
        '<p><strong>Luna Park</strong> 的 Halloween Harvest 官方期间为 <strong>9/18–11/1</strong>，' +
        '整季通票有效期写到 <strong>2026 年 11 月 1 日</strong>。官网活动日历已展开到 10 月 1 日，' +
        '9 月的口径是：<strong>周五 16:00–22:00、周六 11:00–22:00、周日 11:00–20:00、节假周中 12:00–20:00</strong>' +
        '（9/25 五 16:00–22:00、9/26 六 11:00–22:00、9/27 日 11:00–20:00、9/28–10/1 每天 12:00–20:00）。' +
        '<strong>10 月 2 日以后的逐日钟点官网日历尚未展开，未能确认</strong>，' +
        '按 9 月规律推测是「周五 + 周末 + Columbus Day」，但请以官网 lunaparknyc.com/plan/park-hours 为准。</p>' +
        '<p><strong>如果只能挑一天：选 9 月 26 日（周六）。</strong>' +
        '两园同开、Luna Park 开到 22:00、当日日落 18:47、民用暮光结束 19:14——' +
        '<strong>整个蓝调时段完整落在营业时间内</strong>，这是本窗口里唯一毫无悬念的组合。' +
        '次选 10/3、10/10、10/17、10/24 的周六，越早越好（日落越晚，越不容易撞上闭园）。</p>'
    },
    {
      type: 'good',
  ...
  spots: [
    ...
    },
    {
      ...
      access: {
        ...
        hours: '<strong>Brooklyn Bridge Park 每日 06:00–01:00</strong>（官方口径 365 天开放）。' +
          ...
          '<strong>Jane\u2019s Carousel 秋季时刻表（2026 年 9 月 14 日至 12 月 31 日）：' +
          '周一、周二闭馆，周三至周日 11:00–17:50</strong>——' +
          '这个 17:50 早于本窗口每一天的日落，' +
    ...
    },
    {
      ...
      access: {
        ...
        hours: '<strong>官网现行公布的是 2026 年 4 月 1 日至 9 月 30 日的时刻表：</strong>' +
          ...
          '车辆仅周六日 08:00–16:00。' +
          '<strong>10 月 1 日起的 2026 年秋冬时刻表官网尚未公布——未能从官方渠道确认。</strong>' +
          '近年惯例是十月初至十一月初改为 <strong>08:00–18:00</strong>、之后 08:00–17:00。' +
          '<strong>这件事直接决定你能不能拍到日落</strong>：' +
          '9/25–9/30 期间 19:00 关园、当日日落 18:48–18:40，' +
          '<strong>是本窗口内唯一能在园内拍到完整昏金光的时段</strong>；' +
          '若十月照 18:00 执行，10/17（日落 18:13）与 10/22（日落 18:06）都在闭园之后，' +
          '<strong>十月来就拍不到日落</strong>。' +
    ...
    },
    {
      ...
      highlights: [
        '<strong>能不能拍到「亮着灯还在转的摩天轮」，完全取决于你哪天来，这是本条目的全部要点。</strong>' +
          '而且有一个几乎所有攻略都写错的前提：<strong>Wonder Wheel 和 Cyclone 属于两家不同公司、日历不同。</strong>' +
          'Wonder Wheel、Phoenix、Spook-A-Rama 在 <strong>Deno\u2019s Wonder Wheel Amusement Park</strong>；' +
          'Cyclone、Thunderbolt、Tony\u2019s Express 在 <strong>Luna Park</strong>。' +
          ...
          '<strong>10/25 是 2026 赛季最后一天。</strong>详细日期与钟点见本区前置提醒',
      ...
      shots: [
        {
          ...
          desc: '<strong>只在 Deno\u2019s 营业日成立，且必须是蓝调：9/26 为 18:47 日落 → 19:14 暮光结束，' +
            '10/17 为 18:13 → 18:41，10/24 为 18:03 → 18:31。</strong>' +
            '<strong>快门要按转速算，这是这里最容易做错的一件事。</strong>' +
        ...
        },
        {
          ...
          desc: '<strong>需要 Luna Park 的营业日（与 Deno\u2019s 不同，请单独核对官网日历）。</strong>' +
            '<strong>昏金光 17:30–18:10（10 月下旬）拍白色木架结构</strong>——' +
            '低角度暖光会把 1927 年的木桁架照出立体的交叉阴影，这是它最好看的时候；' +
            '<strong>蓝调 18:03–18:31 拍亮灯版本</strong>。' +
      ...
      access: {
        ...
        hours: '<strong>木栈道、沙滩与 Parachute Jump 的夜间照明不受游乐场日历限制。</strong>' +
          ...
          '其余日期闭园（<strong>含 9/25 与 10/2 两个周五</strong>）。' +
          '开门：儿童区 11:00、Wonder Wheel 等成人机械 12:00。' +
          '<strong>闭园钟点随天气浮动，2026 年 10 月的具体时间官网未公布——未能从官方渠道确认</strong>；' +
          '2025 年 10 月的官方口径是 18:00 关，' +
          '<strong>若照此执行则十月中下旬拍不到蓝调亮灯轮</strong>。当天打 (718) 372-2592 确认。' +
          '<strong>Luna Park</strong> 的 Halloween Harvest 期间为 9/18–11/1，' +
          '9 月口径为周五 16:00–22:00、周六 11:00–22:00、周日 11:00–20:00、节假周中 12:00–20:00；' +
          '<strong>10 月 2 日以后的逐日钟点官网日历尚未展开——未能确认</strong>',
      ...
      notes: [
        '<strong>只记一句话：想拍亮灯运转的 Wonder Wheel，把日期定在 9 月 26 日（周六）。</strong>' +
          '两园同开、Luna Park 开到 22:00、日落 18:47、暮光结束 19:14——' +
          '整个蓝调完整落在营业时间内。次选是 10/3、10/10、10/17、10/24 的周六，越早越好',
        '<strong>如果你的日期落在非营业日，请重新设定这一站的目标</strong>：' +
          '拍空栈道、拍 Parachute Jump 的 LED、拍 Cyclone 静止的木桁架、拍沙滩与桥桩。' +
          '这些都不依赖游乐场。<strong>10 月 6–8 日虽然园子关着，' +
