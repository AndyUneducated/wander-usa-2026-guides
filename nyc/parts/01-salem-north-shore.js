module.exports = {
  ...
  lead: '先把结论放在最前面：<strong>10/13–10/15 这三天不要为了 Salem 的殖民地街景来 Salem。</strong>' +
    ...
    'House of the Seven Gables <strong>十月门票涨价并必须提前买定时票、不退不改</strong>——' +
    '这些都不是节假日的临时措施，是<strong>整个十月的常态</strong>，周二到周四同样适用。' +
    '<strong>真正的解法有两个：一是把 Salem 压缩到 06:53 日出到 08:30 这段窗口</strong>' +
    '（Derby Wharf 与 Salem Maritime 的园区 <strong>24 小时开放</strong>，NPS 自己就有一个「在 Derby Wharf 看日出」的官方页面），' +
    '<strong>二是干脆放弃 Salem，把整天交给 Rockport 与 Marblehead</strong>。' +
    '本区九个点里，摄影产出最高的三个（<strong>Rockport 的 Motif No. 1</strong>、' +
    '<strong>Marblehead Old Town 与 Fort Sewall</strong>、<strong>Ipswich 的 Crane Estate</strong>）' +
    '<strong>全部在 Salem 人潮之外，全部不受 Haunted Happenings 影响</strong>，' +
    '其中 Rockport 直接在通勤铁路终点站上，North Station 到 Rockport 约 76–79 分钟。' +
    '另有两件必须先知道的几何事实：<strong>Massachusetts 处在东部时区的最东缘，10/13 日落 18:07、10/15 日落 18:03</strong>，' +
    '拍摄日被压得极短；<strong>而北岸的海岸整体朝东与东北，这是一条日出海岸而不是日落海岸</strong>，' +
    '与加州完全相反——排机位时必须按这个来。',
  callouts: [
    {
      type: 'warn',
      title: '直说：10/13–10/15 的 Salem 是一笔糟糕的摄影买卖',
      html: '<p><strong>2026 年 Haunted Happenings 的日期已核实：10 月 1 日（周四）至 10 月 31 日（周六），全月运行</strong>，' +
        'Grand Parade 是 <strong>10 月 1 日 18:30 从 Shetland Park 出发、约 20:00–20:15 抵达 Salem Common</strong>——' +
        '<strong>注意这是开幕而不是闭幕，10/13–10/15 已在游行之后</strong>，所以你不会撞上游行本身，' +
        '但你会撞上它开启的那个持续四周的街头节庆。</p>' +
        '<p><strong>10/13 是周二、10/14 周三、10/15 周四，这三天没有周末级别的封路，但也不是安静的工作日。</strong>' +
        '关键在于 <strong>10/12（周一）是 Columbus Day / Indigenous Peoples\' Day 假日</strong>，' +
        ...
        '<strong>2026 年确定的两条新规是：① 市政府取消了十月周末的摆渡巴士服务</strong>' +
        '（108 Jefferson Avenue 停车场周末免费但没有摆渡）；' +
        '<strong>② 十月周末与假日的车库、停车场与路边表停费率可改为一次性平价</strong>。' +
        '实时封路与停车位余量看 <strong>parksalem.com</strong>，或装 My Salem MA 与 Destination Salem 两个 App。</p>' +
        '<p><strong>我的建议，不含糊：如果你只有一天做这片北岸，跳过 Salem，去 Rockport 加 Marblehead。</strong>' +
        'Rockport 的 Motif No. 1 与 Bearskin Neck 是整个子地区单点摄影价值最高的目标，' +
        '<strong>直接在 Newburyport/Rockport 线的终点站上，从 North Station 76–79 分钟直达，全程免票</strong>；' +
        'Marblehead Old Town 是一座保存度不输 Salem、但游客量差一个数量级的殖民地海港。' +
        '<strong>如果你实在想要 Salem 的殖民地立面，那就只做日出那一档</strong>（见下一条），' +
        '拍完 08:30 上车走人，不要留下来。</p>'
    },
    {
      type: 'good',
      title: 'Salem 的唯一解法：06:53 日出到 08:30，而且这条路是官方开的',
      html: '<p><strong>已核实：Salem Maritime National Historical Park 的「Derby Wharf 与历史建筑周边园区」' +
        '官方口径为「Open 24/7」</strong>（nps.gov/sama/planyourvisit/basicinfo.htm，' +
        '页面<strong>最后更新于 2026 年 8 月 19 日</strong>，2026 年 9 月 21 日至 11 月 14 日的季节表内明确列出）。' +
        'NPS 另有一个独立的官方活动页 <code>/thingstodo/watch-sunrise-from-derby-wharf.htm</code>，' +
        '原文写着「The Derby Wharf area provides an excellent opportunity to enjoy a New England sunrise」，' +
        '并注明<strong>免费、不需预约、全年、时段标注为 Dawn</strong>，' +
        '海滩上还放了 <strong>6 把 Adirondack 椅</strong>，先到先得。' +
        '<strong>换句话说，「在人潮之前拍 Salem」不是钻空子，是公园自己推荐的玩法。</strong></p>' +
        '<p><strong>执行方案（三天皆适用）：</strong>坐 <strong>05:30 前后从 North Station 出发的第一班车</strong>，' +
        '约 06:10 前后到 Salem 站（工作日班次很密，见交通那条），' +
        '<strong>步行 15 分钟到 Derby Wharf，06:53 日出（10/13）／06:56（10/15）拍完海港与灯塔</strong>，' +
        '然后 07:40–08:30 之间走完 <strong>Chestnut Street 的 McIntire 历史区</strong>' +
        '与 <strong>Witch Trials Memorial</strong>（后者黎明到黄昏免票免预约）。' +
        '<strong>08:30 之后 Essex Street 一带就开始上人，09:00 之后基本收工。</strong></p>' +
        '<p><strong>这个窗口能拍到什么、拍不到什么，要分清：</strong></p>' +
        '<ul>' +
        '<li><strong>能拍</strong>：Derby Wharf 全长 2,045 英尺加尽端的 Derby Wharf Light、' +
        'Friendship of Salem 的船体、Custom House 的外立面、Chestnut Street 整条街、Witch Trials Memorial、' +
        'House of the Seven Gables 的外墙（从 Derby Street 与 Turner Street 街面看）。' +
        '这几样加起来已经是 Salem 摄影价值的八成。</li>' +
        '<li><strong>拍不到</strong>：Charter Street Cemetery（十月<strong>首个入场时段 10:00</strong>、' +
        '且需当日线上预约）、House of the Seven Gables 的室内与花园（<strong>10:00 才开门</strong>）、' +
        'Custom House 室内（<strong>周三至周日 9:30–16:30，周二 10/13 不开</strong>）。</li>' +
        '</ul>' +
        '<p><strong>一个反直觉的加分项：10 月中旬这三天的日出时刻恰好落在低潮附近</strong>' +
        '（Boston 10/13 低潮 07:25、10/15 低潮 08:49），' +
        '所以 Derby Wharf 根部会露出滩石与海藻——这对前景纹理是好事，对「满潮的港口」是坏事。详见潮位那条。</p>'
    },
    {
      type: 'tip',
      title: '日出日落、方位角，以及「这是日出海岸」这条决定一切的几何事实',
      html: '<p>北岸取 <strong>42.5°N, 70.9°W</strong>，以下全部为 <strong>EDT</strong>' +
        '（<strong>2026 年美国夏令时到 11 月 1 日才结束，这三天全在 EDT 内</strong>）。' +
        '数值由 NOAA 太阳位置算法逐分钟计算：</p>' +
        '<ul>' +
        '<li><strong>10/13（周二）</strong>：民用晨光 <strong>06:26</strong>，日出 <strong>06:53</strong>（方位 <strong>99.7°</strong>），' +
        '正午 12:30 高度 <strong>39.6°</strong>，日落 <strong>18:07</strong>（方位 <strong>260.2°</strong>），民用暮光 <strong>18:34</strong>。</li>' +
        '<li><strong>10/14（周三）</strong>：日出 <strong>06:54</strong>（<strong>100.2°</strong>），日落 <strong>18:05</strong>（<strong>259.7°</strong>）。</li>' +
        '<li><strong>10/15（周四）</strong>：民用晨光 <strong>06:28</strong>，日出 <strong>06:56</strong>（方位 <strong>100.8°</strong>），' +
        '正午 12:29 高度 <strong>38.8°</strong>，日落 <strong>18:03</strong>（方位 <strong>259.1°</strong>），民用暮光 <strong>18:30</strong>。</li>' +
        '</ul>' +
        '<p><strong>第一个实际后果：拍摄日极短。</strong>Massachusetts 在东部时区的最东端，' +
        '<strong>18:07 就日落，黄金时段只到 17:20–18:07 的 47 分钟，蓝调在 18:07–18:30</strong>。' +
        '而 Crane Estate 17:00 闭园、Halibut Point 日落即闭园、Parker River 日落即闭园——' +
        '<strong>本区有三个景点的闭园时间与日落几乎同时或更早，等于没有黄金时段可用</strong>，排行程时必须先扣掉这一段。' +
        '同时日出很晚（06:53），所以<strong>晨昏两头都被压缩，一天实际能用的好光只有约两小时</strong>。</p>' +
        '<p><strong>第二个实际后果，也是本区最重要的一条：北岸是日出海岸。</strong>' +
        'Cape Ann 与整条北岸的开阔海面在<strong>东到东北</strong>方向，日出方位 <strong>99.7°–100.8°</strong> 正落在海上，' +
        '日落方位 <strong>259.1°–260.2°</strong> 落在内陆一侧。<strong>这与加州海岸完全相反。</strong>' +
        '据此把九个点分成三类：</p>' +
        '<ul>' +
        '<li><strong>日出主场（06:53–08:00）</strong>：<strong>Salem Derby Wharf</strong>（栈桥朝 152° 伸入海港，' +
        '日出方位 100° 从左前方低角度打来）、<strong>Gloucester 的 Eastern Point Light 与 Dog Bar Breakwater</strong>' +
        '（灯塔在港口东侧、东面朝开阔洋面）、<strong>Plum Island 的海滩与沙丘</strong>（屏障岛的东侧就是大西洋）。</li>' +
        '<li><strong>日落主场（17:00–18:07）</strong>：只有<strong>朝西的港湾</strong>成立——' +
        '<strong>Marblehead Neck 的 Marblehead Light</strong>（在 Neck 上朝西越过港口看老城）、' +
        '<strong>Marblehead 的 Fort Sewall</strong>（在港口北口朝西南看整条港湾）、' +
        '<strong>Rockport 的 Motif No. 1</strong>（从 T Wharf 朝北偏东看，被打亮的是它的西南面）、' +
        '<strong>Gloucester 的 Rocky Neck</strong>（在内港东岸朝西看城与船）、' +
        '<strong>Plum Island 的盐沼</strong>（在保护区公路上朝西看，逆光的金色盐沼）。</li>' +
        '<li><strong>不吃方向、全天可拍</strong>：<strong>Salem 的 Chestnut Street</strong>（街道走向 <strong>72.5°／252.5°</strong>，' +
        '实测自 OSM 路径两端 42.51879／-70.90369 与 42.52001／-70.89847，全长 449 米；' +
        '<strong>北侧那排联邦式立面法向约 162.5°，07:00 到 17:00 全天受光</strong>，' +
        '<strong>而南侧那排法向 342.5°，十月全天零直射</strong>；' +
        '另有一个彩蛋：<strong>日落方位 260° 与街道轴线 252.5° 只差 7.7°，落日基本沿街道纵轴下沉</strong>）、' +
        '<strong>Marblehead 与 Newburyport 的老城街巷</strong>（巷窄楼高，正午高度只有 39°，路面全天柔光）。</li>' +
        '</ul>' +
        '<p><strong>两个需要单独算的几何：</strong></p>' +
        '<ul>' +
        '<li><strong>Crane Estate 的 Grand Allée 走向为 28.6°／208.6°</strong>' +
        '（实测自 OSM「Grand Allée」多边形最长轴，上端 42.68723／-70.77840 到下端 42.69057／-70.77595，长 421 米）。' +
        '也就是说<strong>它朝东北偏北下探到海</strong>。推论一：从 Great House 顺着 Allée 望海是<strong>面向 29°</strong>，' +
        '太阳整天在你右后方，<strong>09:00（方位 123°、高度 21°）与 15:30–16:45（方位 226°–246°、高度 27°–17°）是纯侧光</strong>，' +
        '草地台阶的横向长影会被拉出来，这是这里唯一正确的时段。' +
        '推论二更要紧：<strong>Great House 朝海那一面（法向 29°）只在太阳方位落在 299°–119° 之间才受光，' +
        '10/13 这段时间是日出 06:53 到约 08:40——而园区 09:00 才开门。' +
        '所以「阳光正打在 Great House 海侧立面上」这张照片，在十月的开放时间内根本拍不到。</strong></li>' +
        '<li><strong>Halibut Point 朝正北面对开阔大洋</strong>（法向约 350°）。' +
        '要让朝北的岩壁受光，太阳方位得落在 260°–80° 之间；而这三天太阳只在 <strong>100°–260°</strong> 之间走。' +
        '<strong>结论：十月这三天，Halibut Point 朝海的花岩壁面与采石坑的海侧壁全天零直射光，一分钟都没有。</strong>' +
        '站在岬角朝北看海时太阳整天在你背后，画面是平的、没有立体感。' +
        '<strong>唯一有方向感的光是日落前 45 分钟（17:20–18:03，方位 251°–259°）从西南西横扫过岩脊的掠射光</strong>' +
        '（日出那一档同理，但公园 <strong>8:00 才开门</strong>，06:53 的日出用不上）。' +
        '<strong>所以这里正确的定位是：阴天题材、蓝调题材、以及日落前那 45 分钟的横向掠射光。</strong></li>' +
        '</ul>'
    },
    {
      type: 'info',
      title: '潮位（10/13–15 实测预报）与秋色时间（北岸比内陆晚，这三天偏早）',
      html: '<p><strong>潮位。</strong>数据取自 <strong>NOAA Tides &amp; Currents 官方预报 API</strong>，' +
        '<strong>Boston 站（8443970）</strong>与<strong>Gloucester 站（8447435）</strong>，均为当地时（EDT）。' +
        '两站差别很大，必须分开用：<strong>Boston 潮差约 10 英尺，Gloucester 只有 5–6 英尺，' +
        '而且 Gloucester 比 Boston 晚约 50 分钟</strong>（Boston 在 Massachusetts Bay 内部有放大效应，Cape Ann 在外侧）。</p>' +
        '<ul>' +
        '<li><strong>Boston（用于 Salem、Marblehead、Newburyport）</strong>：' +
        '<strong>10/13</strong> 高 01:29（9.6 ft）／低 <strong>07:25</strong>（0.9）／高 <strong>13:35</strong>（10.3）／低 19:57（0.1）；' +
        '<strong>10/14</strong> 高 02:12／低 <strong>08:07</strong>（1.3）／高 <strong>14:16</strong>（10.1）／低 20:41；' +
        '<strong>10/15</strong> 高 02:55／低 <strong>08:49</strong>（1.7）／高 <strong>14:59</strong>（9.7）／低 21:26。</li>' +
        '<li><strong>Gloucester（用于 Rockport、Gloucester、Ipswich 的 Crane Beach）</strong>：' +
        '<strong>10/13</strong> 高 02:21／低 <strong>08:40</strong>（0.4）／高 <strong>14:24</strong>（5.7）／低 21:25（-0.1）；' +
        '<strong>10/14</strong> 高 03:06／低 <strong>09:19</strong>／高 <strong>15:05</strong>（5.5）／低 22:09；' +
        '<strong>10/15</strong> 高 03:53／低 <strong>09:58</strong>／高 <strong>15:48</strong>（5.3）／低 22:53。</li>' +
        '</ul>' +
        '<p><strong>哪些点要低潮、哪些点要高潮：</strong></p>' +
        '<ul>' +
        '<li><strong>要低潮</strong>：<strong>Crane Beach 与 Steep Hill Beach</strong>（低潮露出极宽的沙坪与波痕，' +
        '这三天的低潮在 <strong>08:40／09:19／09:58</strong>，正好卡在 Castle Hill 09:00 开园之后，配合极佳）；' +
        '<strong>Gloucester 的 Dog Bar Breakwater</strong>（花岩块面在低潮时露得多、落脚更安全，' +
        '<strong>涨潮加涌浪时花岩极滑，不要上</strong>）；<strong>Halibut Point 的潮池</strong>。</li>' +
        '<li><strong>要高潮</strong>：<strong>Rockport 内港（Motif No. 1）</strong>——高潮才没有露出的泥与水草、' +
        '船身浮起、倒影完整。<strong>这里出现了整个行程最漂亮的一次巧合：10/15 Gloucester 高潮 15:48，' +
        '而 Motif No. 1 的最佳光线是 15:30–17:45，两者几乎完全重合。</strong>' +
        '10/13 的高潮 14:24 略早一点，也仍在可用范围。' +
        '<strong>Plum Island 的盐沼</strong>也偏好高潮（潮沟灌满水，金色草与蓝色水才有对比）。</li>' +
        '<li><strong>要注意的坏消息</strong>：<strong>Salem Derby Wharf 的日出恰好赶上低潮</strong>' +
        '（10/13 日出 06:53、低潮 07:25），栈桥根部会露出滩石。' +
        '把它当纹理前景用是加分，想拍「满潮的港口」就只能等 13:35–14:59——而那是人最多的时段。</li>' +
        '</ul>' +
        '<p><strong>秋色时间——这一条要纠正一个常见误判。</strong>' +
        '<strong>Massachusetts 沿海的秋色比内陆晚一到两周，比 Vermont 与 New Hampshire 晚两到四周。</strong>' +
        '各方口径：全州综合峰值约 <strong>10 月 7–15 日</strong>（内陆与 Berkshires 主导）；' +
        '但 <strong>Greater Boston、North Shore 与 Cape Ann 的峰值普遍给到 10 月 18 日至 11 月 1 日</strong>，' +
        ...
        '如果你的核心目的是秋色，<strong>10/13–10/15 来北岸海岸线是早了约十天</strong>，' +
        '同期真正在峰值上的是 Berkshires 与中部 Massachusetts（内陆方向），但那不是本区。' +
        '<strong>反过来有一个真正在时间点上的题材：盐沼。</strong>' +
        'Spartina 盐沼草的转色与树木无关，<strong>十月中旬正是它从绿转成铜金色的时候</strong>，' +
        'Parker River、Plum Island Sound 与 Crane Estate 后侧的大片盐沼在这三天状态正好，' +
        '<strong>这是本区被严重低估、而且时间点完全对得上的题材</strong>。' +
        '（以上为区域气候常规与多方预测的综合，<strong>2026 年当年的实际转色进度无法提前核实</strong>，' +
        '出发前刷 mass.gov 的 foliage report。）</p>'
    },
    {
      type: 'info',
      title: 'MBTA Newburyport/Rockport 线实操，以及哪些点无车到不了',
      html: '<p>这是无车旅行者的决定性因素。以下时刻取自 <strong>MBTA 官方 Newburyport/Rockport 线工作日时刻表</strong>' +
        '（读取日期 2026-10-09 的工作日班表；<strong>注意 MBTA 网站在 2026 年 9 月初仍只提供到 9 月 5 日为止的 Spring/Summer 时刻表，' +
        '10 月的秋季表当时尚未发布，以下为现行工作日班表的实测行车时间，班次时刻可能微调</strong>）。' +
        '全线从 <strong>North Station</strong> 发车，在 <strong>Beverly</strong> 分岔为 Rockport 支线与 Newburyport 支线，' +
        '<strong>两条支线的车都停 Salem</strong>。</p>' +
        '<ul>' +
        '<li><strong>Salem</strong>：约 <strong>33–37 分钟</strong>，单程 <strong>$8.00</strong>（Zone 3；优惠票 $4）。' +
        '工作日班次极密，早晚高峰约每 30 分钟一班，白天 30–60 分钟一班，末班约 23:00 之后。' +
        '<strong>车站到 Derby Wharf 步行约 1.2 公里／15 分钟，到 Chestnut Street 约 900 米／11 分钟。</strong></li>' +
        '<li><strong>Rockport</strong>（终点站）：约 <strong>76–79 分钟</strong>。' +
        '<strong>下车走 10–15 分钟即到 Bearskin Neck 与 Motif No. 1，这是全区可达性最好的重点目标。</strong></li>' +
        '<li><strong>Gloucester</strong>：约 <strong>68–70 分钟</strong>。' +
        '车站到 Man at the Wheel（Stacy Boulevard）约 1.3 公里／16 分钟，到 Rocky Neck 约 3 公里／35 分钟。</li>' +
        '<li><strong>Newburyport</strong>（终点站）：约 <strong>65–72 分钟</strong>。' +
        '车站到 Market Square 老城约 1.3 公里／16 分钟。</li>' +
        '<li><strong>Ipswich</strong>：约 <strong>53–59 分钟</strong>。' +
        '<strong>但车站到 Crane Estate 大门有 5.9 公里，没有公交，必须打车。</strong></li>' +
        '</ul>' +
        '<p><strong>关于十月的加开班次，有一条要纠正的常见误解：MBTA 的 Haunted Happenings 加班车只加周末。</strong>' +
        'MBTA 历年（2024、2025）的官方新闻稿措辞都是「Several extra trains will run on <strong>Saturdays and Sundays</strong>」，' +
        '并配套 <strong>$10 周末通勤铁路通票</strong>与 10 月 31 日的 <strong>$10 Haunted Happenings 单日通票</strong>。' +
        '<strong>10/13–10/15 是周二至周四，没有加班车，跑的是常规工作日班表。</strong>' +
        '这其实不是坏事——工作日班表本身就比周末密，而且车上没有周末那种满载的节庆人流；' +
        '<strong>但 $10 周末通票在这三天也用不了，得按 $8 单程买。</strong>' +
        '（<strong>2026 年的 Haunted Happenings 加班车时刻表在 2026 年 9 月初尚未发布，未能核实</strong>。）</p>' +
        '<p><strong>无车可达性分级，这是本条最有用的部分：</strong></p>' +
        '<ul>' +
        '<li><strong>火车直达、下车即走到（最优）</strong>：Salem 三个点、<strong>Rockport 的 Motif No. 1 与 Bearskin Neck</strong>、' +
        'Gloucester 的 Man at the Wheel、Newburyport 老城。</li>' +
        '<li><strong>火车加一段 30–45 分钟步行（可接受）</strong>：<strong>Halibut Point State Park</strong>' +
        '（Rockport 站到 Gott Avenue 约 3.2 公里／40 分钟，沿 Route 127 有人行道）、' +
        'Gloucester 的 Rocky Neck（约 3 公里／35 分钟）。</li>' +
        '<li><strong>必须打车或换公交（明显不便）</strong>：<strong>Marblehead</strong>——' +
        '<strong>不在通勤铁路上</strong>。从 Salem 站没有直达公交，要坐 <strong>455 路到 Lynn 再换 441／442 路</strong>，' +
        '实测约 <strong>60–83 分钟</strong>、票价 $3.40；' +
        '<strong>更快的走法是从 Boston 市区坐蓝线到 Wonderland 再换 441／442 路直达 Marblehead</strong>，' +
        '合计约 1 小时 15 分。或者从 Salem 站直接打车，约 6.5 公里、10–15 分钟。' +
        '<strong>Crane Estate（Ipswich 站打车 5.9 公里）与 Plum Island／Parker River（Newburyport 站打车 6 公里，' +
        '岛上无公交）也都必须打车。</strong>' +
        '<strong>Gloucester 的 Eastern Point Light 最糟：从 Gloucester 站有 5.5 公里，' +
        '而且最后 2.6 公里是挂着「Private Road」牌子的 Eastern Point Boulevard，步行时间约 70 分钟，' +
        '实务上必须开车或打车。</strong></li>' +
        '</ul>' +
        '<p><strong>一条串点建议：Rockport 支线的车经停 Salem，所以「Salem 日出 + Rockport 白天」是同一条线上的一趟车能做完的</strong>' +
        '（Salem 到 Rockport 约 40 分钟）。反过来 Marblehead 与 Rockport 不在一天里，硬凑会把时间全花在换乘上。</p>'
    }
  ],
  spots: [
    {
      ...
      highlights: [
        ...
        '<strong>十月的票务规则是硬约束，必须提前几周处理：</strong>' +
          ...
          '也就是说<strong>你要拍 10/13–10/15，得在 9 月 4 日开卖那天就去抢</strong>。',
      ...
      shots: [
        {
          ...
          desc: '<strong>坐标为 OSM 的 The House of the Seven Gables 实体节点（115 Derby Street）。</strong>' +
            ...
            '<strong>最佳 06:53–08:00</strong>（10/13 日出 06:53、方位 99.7°、高度 0°→11°）：' +
        ...
        },
        {
          ...
          desc: '<strong>无独立 OSM 实体，地图无针脚（位于 115 Derby Street 园区内，在主建筑东南侧靠海港一侧）。</strong>' +
            ...
            '10/13 的 17:00 太阳高度只有 10.7°、方位 248.6°，' +
      ...
      access: {
        book: '<strong>十月必须提前买定时票，官方原文「Advance tickets are REQUIRED」。</strong>' +
          '<strong>10 月 1–15 日的票于 9 月 1 日对会员、9 月 4 日对公众开放购买</strong>；' +
          '10 月 16–31 日的票于 9 月 16 日与 9 月 19 日开放。' +
        ...
        ticket: '<strong>十月 Mansion Tour Package（含 Grounds Pass）：成人 $31、' +
          '老年 65+／急救人员／教师／大学生 $26、儿童 5–12 岁 $21、无障碍票 $16、5 岁以下免费。</strong>' +
          '<strong>Salem 居民、NARM 会员／博物馆同业、SNAP／WIC／EBT 持卡人、Massachusetts 公立院校学生免费</strong>' +
          '（均需证件）。' +
          '<strong>11 月至次年 9 月同一张票为成人 $26，十月是唯一涨价的月份。</strong>' +
          '<strong>Grounds Pass 单卖，但官网价目表未列出其十月价格，未能从官方渠道核实。</strong>' +
          '<strong>从 Turner Street 与 Derby Street 街面拍外观完全免费。</strong>',
        hours: '官方原文（7gables.org，站头横幅）：<strong>「Open daily 10 A.M.-6 P.M.」</strong>，' +
          '<strong>秋季无每周固定闭馆日，周一至周日均开</strong>——' +
          '<strong>10 月 13 日（周二）正常开放</strong>。' +
          'Grounds Pass 的最晚入场时间随季节为 16:00／17:00／18:00 三档之一（官方措辞「last entry at close (4,5,or 6PM seasonally)」），' +
      ...
      notes: [
        '<strong>票务是本条目最大的风险，不是光线。</strong>' +
          '10/13–10/15 的票在 <strong>9 月 4 日</strong>对公众开卖，' +
    ...
    },
    {
      ...
      highlights: [
        ...
        '<strong>栈桥的走向是本条目的关键几何，而且它正好指向对的方向。</strong>' +
          ...
          '尽端灯塔距岸约 570 米。' +
          '<strong>Salem 港在这里向东南方向敞开，而 10/13 日出方位是 99.7°</strong>——' +
        ...
        '<strong>室内建筑的开放日必须单独看，而且 10/13 周二正好撞上闭馆。</strong>' +
          ...
          '<strong>→ 10 月 13 日（周二）这些室内全部不开，只能拍外立面；10/14 与 10/15 正常开。</strong>' +
      ...
      shots: [
        {
          ...
          desc: '<strong>坐标为 OSM 的 Derby Wharf 实体（栈桥中段）。</strong>' +
            '<strong>最佳 06:40–07:45（10/13 日出 06:53，方位 99.7°；10/15 日出 06:56，方位 100.8°），' +
            ...
            '<strong>潮位注意：10/13 低潮 07:25、10/15 低潮 08:49（Boston 站），' +
        ...
        },
        {
          ...
          desc: '<strong>坐标为 OSM 的 Custom House 实体（164/174/178 Derby Street）。</strong>' +
            ...
            '<strong>室内只在周三至周日 9:30–16:30 开，10/13 周二不开</strong>，' +
            '但外立面在公共人行道上 24 小时可拍。' +
      ...
      access: {
        ...
        hours: 'NPS 官方 2026 年 9 月 21 日至 11 月 14 日季节表原文' +
          '（nps.gov/sama/planyourvisit/basicinfo.htm，<strong>2026 年 8 月 19 日更新</strong>）：' +
          '<strong>「Derby Wharf and Park Grounds Around Historic Structures — Open 24/7」</strong>；' +
          '<strong>Salem Armory Regional Visitor Center 与 Waite &amp; Peirce Park Store 每日 9:30–16:30</strong>；' +
          '<strong>Custom House 与 Public Stores &amp; Scale House 周三至周日 9:30–16:30</strong>（后者视天气）；' +
          '<strong>Narbonne House 周三至周日 13:00–16:00</strong>；' +
          '<strong>Derby House 在这个季节标注为「Closed for the season」</strong>；' +
          'Central Wharf 洗手间每日 9:30–16:30。' +
          '<strong>→ 10 月 13 日（周二）所有室内不开，栈桥与园区照常 24 小时可进。</strong>' +
          '全年只在 Thanksgiving、Christmas Day、New Year\'s Day 闭馆。',
      ...
      notes: [
        ...
        '<strong>日出恰逢低潮</strong>（10/13 低潮 07:25、10/14 08:07、10/15 08:49，Boston 站）。' +
          '滩石与海藻会露出来——当纹理用是好事，' +
    ...
    },
    {
      ...
      highlights: [
        ...
        '<strong>Chestnut Street 的几何算得很干净，而且有一个彩蛋。</strong>' +
          ...
          '10 月 13 日太阳方位从 07:00 的 101° 走到 17:00 的 249°，全部落在 72.5°–252.5° 区间内，' +
          '所以北侧立面全天受光</strong>，' +
          '而<strong>南侧那排法向 342.5°（朝北偏西），十月全天零直射光</strong>。' +
          '推论二（彩蛋）：<strong>10/13 日落方位 260.2°、10/15 为 259.1°，' +
      ...
      shots: [
        {
          ...
          desc: '<strong>坐标为 OSM 的 Chestnut Street 路径中点。</strong>' +
            '<strong>最佳 07:30–10:00</strong>：10/13 的 08:00 太阳高度 10.9°、方位 111.4°，' +
            ...
            '<strong>第三档也是最特殊的一档：17:45–18:07（10/13 日落 18:07，方位 260.2°）</strong>——' +
        ...
        },
        {
          ...
          desc: '<strong>坐标为 OSM 的 Charter Street Cemetery 实体。</strong>' +
            ...
            '10/13 的 10:00 太阳高度已有 29.2°、方位 136.4°。' +
        ...
        },
        {
          ...
          desc: '<strong>坐标为 OSM 的 Salem Common 公园实体。</strong>' +
            ...
            '<strong>要拍「安静的殖民地公共绿地」这三天做不到，请把它当成节庆纪实题材而不是风景题材。</strong>' +
      ...
      access: {
        ...
        ticket: '<strong>三处全部免费</strong>（墓园的十月预约也免费）。' +
          '墓园旁的 Charter Street Cemetery Welcome Center（历史建筑 Pickman House 内）亦免费。',
        hours: '<strong>Chestnut Street：公共街道，24 小时。</strong>' +
          '<strong>Witch Trials Memorial：官方口径「open from dawn till dusk」，即黎明到黄昏</strong>' +
          '（这三天约 06:26–18:34），并注明可能因维护临时关闭。' +
          '<strong>Old Burying Point：Welcome Center 夏季表为每日 10:00–17:00、最晚入场 16:45；' +
          '十月版本为首场 10:00 入场、17:00 关门</strong>。' +
          'Thanksgiving、Christmas Eve、Christmas Day、New Year\'s Eve、New Year\'s Day 与联邦假日闭园，' +
          '<strong>恶劣天气可能临时闭园</strong>。' +
          '<strong>秋季无每周固定闭馆日——10 月 13 日（周二）三处均正常。</strong>' +
          '<strong>有一处口径不一致要提醒：一份二手来源写墓园十月只开 12:00–15:45、时段为 10 分钟一档，' +
          '而官方页面写首场 10:00、15 分钟一档、17:00 关门。以官方页面为准，' +
          '但这处矛盾说明规则年年在改，出发当天务必刷一次官网。</strong>',
      ...
      notes: [
        ...
        '<strong>10/13 是周二，这三处都不受影响</strong>（无每周闭馆日）；' +
