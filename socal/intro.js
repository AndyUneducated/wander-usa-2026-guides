...
(function () {
  ...
  var PLAN = [
    ...
    '<p>这份清单里的景点大约是 <strong>7–8 天</strong>的内容量。以 San Jose 出发的 5 天环线为例：',
    'Day 1 要花约 4 小时南下，Day 5 要花 <strong>9–11 小时</strong>北返，',
    '真正完整可用的只有 Day 2、3、4 三个白天。要在这三天里覆盖中央海岸 + Santa Barbara + Malibu + 整个 LA + Laguna + San Diego，',
    '结果只会是每站都压缩成「停车—拍三张—上车」。</p>',
    '<p>所以这一本不按「照着走的行程单」来写，而是一份<strong>现场决策手册</strong>——',
    '每个点位都给足坐标、光线窗口、潮汐条件与关闭风险，',
    '可以在路上根据当天的烟况、车位和潮位<strong>临场取舍</strong>。逐日骨架按「必去」与「顺路可选」两层排，',
    '不把二十多个点硬塞进 5 天。</p>',
    '<p>四处高代价项值得先掂量：Salton Sea 支线净增 7–8.5 小时且完全反向；',
