...
var REGIONS = [
  ...
  },
  {
    ...
    "color": "#ffd24d",
    "lead": "Benjamin Franklin Parkway 是一条<strong>方位角 134.8° 的笔直斜轴</strong>：Philadelphia Museum of Art 台阶顶端、Washington Monument、Swann Memorial Fountain、City Hall 塔楼四点几乎精确落在同一条线上（实测偏差不到 1°）。这条轴线决定了本区几乎所有构图。<strong>但本区最大的问题不是光线，是闭馆日</strong>——Philadelphia Museum of Art 与 Barnes Foundation <strong>都是周二、周三闭馆</strong>，Fairmount Water Works 室内又是周日、周一、周二闭馆，三家的闭馆表互相错开却又在周二完全重叠。<strong>周二来这一区，六个点里只剩 Eastern State 加三个户外点。</strong>好消息是本区摄影价值最高的一个点恰好是全年每天开门的：Eastern State Penitentiary，不但每天 10:00–17:00 开放，还是全美对摄影者最友好的废墟内景之一——花 $10 买一张器材通行证就可以合法架三脚架。<strong>已核实：Halloween Nights（2026 年 10 月 2 日–11 月 7 日部分夜晚）不影响白天历史遗址的正常开放。</strong>",
    "callouts": [
      {
        "type": "warn",
        "title": "闭馆日交叉对照表：周二是本区的死日",
        "html": "<p>以下时间取自各馆官网（philamuseum.org / barnesfoundation.org / easternstate.org / fairmountwaterworks.org），核实时间 2026 年 9 月。<strong>三家室内场馆的闭馆日在周二完全重叠。</strong></p><table><thead><tr><th>周几</th><th>Philadelphia Museum of Art</th><th>Barnes Foundation</th><th>Eastern State Penitentiary</th><th>Fairmount Water Works 室内</th></tr></thead><tbody><tr><td>周一</td><td>10:00–17:00</td><td>11:00–17:00</td><td>10:00–17:00</td><td><strong>闭馆</strong></td></tr><tr><td><strong>周二</strong></td><td><strong>闭馆</strong></td><td><strong>闭馆</strong></td><td>10:00–17:00</td><td><strong>闭馆</strong></td></tr><tr><td><strong>周三</strong></td><td><strong>闭馆</strong></td><td><strong>闭馆</strong></td><td>10:00–17:00</td><td>10:00–17:00</td></tr><tr><td>周四</td><td>10:00–17:00</td><td>11:00–17:00</td><td>10:00–17:00</td><td>10:00–17:00</td></tr><tr><td><strong>周五</strong></td><td><strong>10:00–20:45</strong></td><td>11:00–17:00</td><td>10:00–17:00</td><td>10:00–17:00</td></tr><tr><td>周六</td><td>10:00–17:00</td><td>11:00–17:00</td><td>10:00–17:00</td><td>10:00–17:00</td></tr><tr><td>周日</td><td>10:00–17:00</td><td>11:00–17:00</td><td>10:00–17:00</td><td><strong>闭馆</strong></td></tr></tbody></table><p><strong>结论：周五是本区唯一的满分日。</strong>Philadelphia Museum of Art 周五延长到 20:45，且 <strong>17:00 后 Pay What You Wish</strong>（官方 2026 年 9 月 3 日发稿宣布延长至 2027 年 6 月 25 日）——这意味着周五你可以在馆内拍到日落，出来正好赶上 Parkway 黄金时段与蓝调。<strong>周二只能拍 Eastern State 加 Swann Fountain、Boathouse Row、Water Works 外景。</strong>Swann Memorial Fountain 与 Boathouse Row 全天候免费开放，不受任何闭馆日影响。</p>"
      },
      {
        "type": "good",
        "title": "Eastern State 十月不会变成鬼屋：白天照常开放（已核实）",
        "html": "<p>这是本区风险最高的一条，结论是好消息。<strong>Halloween Nights 2026 的官方档期是 10 月 2 日至 11 月 7 日的部分夜晚</strong>（easternstate.org/halloween FAQ 原文：「open select nights from October 2 through November 7, 2026」）。这是一个<strong>独立售票的夜间活动，与白天门票完全分开</strong>，官方在 Halloween Nights 的 FAQ 里主动写着「Come back and visit the historic site during the day! Add daytime historic site admission to your Halloween Nights ticket purchase and save up to $5.」，主办方历年对外口径也是「Halloween Nights does not affect operation of the historic site, which remains open for daytime museum admission」。</p><p>官网 Hours of Operation 页面对 <strong>3 月至 11 月的口径是「Open Daily, 10:00 a.m. to 5:00 p.m.」，十月没有任何例外日</strong>，整个九月下旬到十月底唯一列出的闭馆日是感恩节（11 月 26 日），已在你的窗口之外。<strong>所以白天摄影不会被 Halloween 活动挤掉。</strong></p><p>唯一需要预期管理的是：五座鬼屋（Dark Tides、Big Top Terror、Machine Shop、Nightmares、The Crypt）就搭在真实牢房区内部，布景与灯光桁架从九月起就在场内。<strong>官方从未声明白天参观路线会因此缩减，但也从未声明不会</strong>——<strong>「十月白天某几条牢房走廊是否会出现现代布景、或临时不在动线上」未能从官方渠道确认</strong>。若你要拍的是绝对干净的废墟内景，九月下旬（10 月 2 日之前）明显比十月保险。</p>"
      },
      {
        "type": "info",
        "title": "日出日落与 Parkway 轴线：为什么招牌机位是日落而不是日出",
        "html": "<p>Philadelphia（39.9526, -75.1652），两个参考日期均为 EDT（2026 年夏令时到 11 月 1 日才结束）：</p><ul><li><strong>9 月 25 日</strong>：日出 <strong>06:50</strong>（方位 90°），日落 <strong>18:54</strong>（方位 270°），正午 12:53（太阳高度 49.3°），民用晨光 06:24 起、民用暮光至 <strong>19:20</strong>。</li><li><strong>10 月 22 日</strong>：日出 <strong>07:17</strong>（方位 104°），日落 <strong>18:12</strong>（方位 256°），正午 12:45（太阳高度 39.1°），民用晨光 06:51 起、民用暮光至 <strong>18:39</strong>。</li></ul><p><strong>Parkway 轴线是 134.8°（从美术馆台阶顶望向 City Hall），反向 314.8°。</strong>费城纬度下太阳日出方位极值是冬至 120°、日落方位极值是夏至 302°——<strong>也就是说一年之中太阳既不会从 134.8° 升起，也不会落到 314.8°，这条轴线永远不会出现「太阳正对轴线」的现象。</strong>别指望这里有 Manhattanhenge 那种日子。</p><p>结论很干脆：<strong>「台阶顶端回望 Parkway」是日落机位</strong>。视线 134.8°、太阳在 256–270°，也就是<strong>正落在你右后方约 130°</strong>，整条 Parkway 与 City Hall 塔楼西北面被低角度暖光完全正面照亮。日出时太阳在 90–104°，位于视线左侧 31–45°，是强侧逆光，能拍但反差极难控制。</p>"
      },
      {
        "type": "tip",
        "title": "秋色时间表：晚九月太早，晚十月正中",
        "html": "<p>费城属宾州最晚变色的角落。多个物候模型对 <strong>Philadelphia County 的 2026 年峰值给出 10 月 16–24 日</strong>（另一模型中位数 10 月 22 日，误差带 ±13 天）；宾州 DCNR 的常年口径是「东南角要等到十月底」，《Inquirer》引用 DCNR 预报员的说法更直接：<strong>费城地区的高潮平均落在万圣节前后</strong>。</p><p>换算成可操作的判断：<strong>9 月 25 日前后 Kelly Drive 与 Fairmount Park 基本还是全绿</strong>，零星早红的枫树而已，不要为秋色专门安排这一段；<strong>10 月 22 日前后是本窗口内最接近峰值的日子</strong>，10 月 20 日至 11 月 1 日是最佳区间。峰值持续期通常只有 7–10 天，干旱年更短。出发前查 DCNR 每周秋色报告（九月底开始更新）比查任何预测图都准。</p><p>本区的秋色主体是 <strong>Kelly Drive 与 Waterworks Drive 沿河一线</strong>，Boathouse Row 背后的坡地与 Fairmount Water Works 的南北 Cliffside Path 都在这条带上，晚十月来的话，Boathouse Row 蓝调机位可以顺手把彩叶收进前景。</p>"
      },
      {
        "type": "warn",
        "title": "两条容易踩的交通坑：MLK Drive 周末封车、10/24–25 赛艇大赛",
        "html": "<p><strong>Boathouse Row 的经典对岸机位在 Martin Luther King Jr. Drive 西岸，而这条路 2026 年 3 月 28 日至 11 月 29 日每个周末封闭机动车（周六 07:00 至周一 07:00）</strong>，区间为 East Falls Bridge 至 MLK Bridge / Eakins Oval。封路期间步行与自行车照常通行，<strong>但你没法把车开到机位旁边，且封路闸门夜间上锁</strong>——这直接影响周末的蓝调夜拍安排。10 月 10–12 日（Indigenous Peoples Day）为加长封闭。工作日 MLK Drive 正常通车，夜拍走工作日最省事。</p><p><strong>10 月 24–25 日是 Head of the Schuylkill Regatta</strong>，当周末 MLK Drive <strong>反而不封车</strong>（为赛事运营留通道）。这两天 Boathouse Row 一带是全年人流与车流最密的时候，停车基本无望；但反过来说，这也是唯一能在 Boathouse Row 前拍到成百条赛艇的两天，看你要什么。</p>"
      }
    ],
    "spots": [
      {
        ...
        "highlights": [
          "1829 年 10 月 25 日开放，英国建筑师 <strong>John Haviland</strong> 设计，是世界第一座真正意义上的 penitentiary。<strong>radial plan（辐射式平面）</strong>：一个八角形中央监视塔向外伸出七条单层牢房翼，像自行车轮的辐条，理论上一名狱警站在中心就能同时看见每条走廊的入口。<strong>对摄影者的直接后果是：无论你站在哪里，面前永远有一条向远处收缩的长走廊</strong>——这栋建筑天生就在给你透视消失点",
          "牢房 8×12 英尺、层高 10 英尺，配热水暖气、水龙头与抽水马桶（<strong>比白宫装抽水马桶还早</strong>），每间有独立小放风院，囚犯彼此终生不见面，入监时要被套上头罩以免记住路径。每间牢房顶部只有<strong>一个圆形天窗，贵格会称之为「Eye of God」</strong>——这是全场最重要的一个摄影事实：<strong>牢房内唯一光源是头顶那束光</strong>",
          "<strong>1994 年开放参观时做了一个决定性的选择：不修复，只做「stabilized ruin」（稳定化废墟）。</strong>剥落的漆皮就让它继续剥落，塌穿的屋顶就让它继续朝天开着。于是墙面上是一层层压缩的机构色——机构绿、机构米、机构白，<strong>这是全美最容易在合法前提下拍到的「废墟内景」，没有第二个同量级的选择</strong>",
          "<strong>Charles Dickens 1842 年专程来看，回去写下他此生对美国最严厉的一段评论</strong>，认为长期单独关押是对心智的折磨。这套系统 1913 年因超收被放弃，监狱转为群居制运作至 1971 年关闭。<strong>Haviland 的平面最终被全球五大洲 300 多座监狱抄走</strong>",
          "现场可拍的具体点位：<strong>Al Capone 那间被布置回 1929 年模样的牢房</strong>（他因携枪服刑八个月，据说有地毯、台灯和收音机）、<strong>囚犯自建的犹太会堂</strong>、Cellblock 15（死囚区）、<strong>Willie Sutton 1945 年越狱地道的入口</strong>、Cellblock 3（医院区），以及 14 组当代艺术装置与 The Big Graph 数据雕塑"
        ],
        "photo": "建筑与废墟 <strong>5/5</strong>，人像 <strong>4.5/5</strong>，风光 0/5。<strong>官方原话是「may be the most picturesque place you’ve seen in years」并鼓励带相机</strong>——在美国的历史场馆里这种态度极罕见。唯一扣分项是光比极端，需要器材证或包围曝光来应对。",
        "shots": [
          {
            "name": "Cellblock 7 / 两层牢房主走廊（招牌构图）",
            "desc": "<strong>桶形拱顶＋顶部天窗带＋两侧铁门排列成的单点透视，是本场第一构图</strong>。<strong>时段 11:00–14:00 是唯一成立的窗口</strong>：9/25 正午太阳高度 49.3°、10/22 39.1°，此时阳光角度足够陡，能穿过拱顶天窗在地面砸出清晰光斑；<strong>早于 10:00 或晚于 15:30 走廊会退成一片平淡的灰</strong>。<strong>14–24mm 超广，机身压到腰高甚至更低</strong>，让地面湿痕与光斑一起进画。<strong>光比通常 10–14 EV，必须包围 5 张做 HDR</strong>；若买了器材证就架三脚架拍 1/4s–2s 的 f/8 序列，画质天差地别。坐标取自 OSM 场地面中心（约在中央监视塔位置），为<strong>推算</strong>值。",
            "park": [
              39.967533,
              -75.172691
            ],
          ...
          },
          {
            ...
            "desc": "<strong>这是全场光比最极端的一格：天窗与墙角的差可以超过 14 EV。</strong><strong>正午前后 11:30–13:30</strong> 那束光会落在地面或对墙上，形成明确的亮斑；其余时段整间牢房只是均匀的暗。<strong>没有三脚架时的手持方案</strong>：f/2.8、ISO 3200–6400、1/40–1/60s、开机身防抖，<strong>把测光锁在天窗光斑上、让暗部彻底沉下去拍剪影式高反差</strong>，这比试图「拍全」要好看得多。想拍到细节完整的版本必须包围 7 张、间隔 1.5 EV。<strong>无 OSM 实体节点，地图无针脚</strong>。",
            "park": [
              39.967533,
              -75.172691
            ]
          },
          {
            ...
            "desc": "入口立面是刻意做成中世纪城堡样式的花岗岩幕墙——Haviland 要用它「让想犯罪的人心生恐惧」。<strong>墙面朝南偏东，上午到正午受光</strong>，<strong>建议 09:00–11:00</strong>，24–35mm 贴墙仰拍强调城垛与箭孔的重复，或退到 Fairmount Avenue 对面人行道用 50mm 拍完整立面。这栋楼占满一整个街区，<strong>沿 22nd Street 与 Brown Street 走一圈可以拍到未经修饰的原始围墙</strong>，比正门更像废墟。这一机位在收费区之外，随时可拍。",
            "park": [
              39.967533,
              -75.172691
            ],
        ...
        "access": {
          "book": "<strong>强烈建议线上预约</strong>（easternstate.org/tickets）。两种白天票二选一：<strong>Self-Guided Audio Tour</strong>（自由进出，主线 10 站约 40 分钟）或 <strong>Guide-Led Tour & Discussion</strong>（45 分钟讲解，票为日期＋时刻锁定）。<strong>2026 年 9 月 8 日起导览团大幅缩减：工作日只剩 12:00 一场，周六日 11:00 一场</strong>（9 月 7 日之前是每天 10:30/11:30/12:30 三场）。<strong>导览团准点出发，迟到不补</strong>。白天票可在 24 小时前免费改期或退票（发信 support@easternstate.org）",
          "ticket": "<strong>线上：成人 $21，长者 $19，大学生与 7–17 岁 $17；现场窗口各贵 $2（$23/$21/$19）</strong>。一张票含音频导览、Mini Tours、全部展览与艺术装置。SEPTA Key 卡成人票线上再减 $2。不建议 7 岁以下儿童入场。<strong>另需单独购买 $10/人/日的「photography equipment pass」才能使用三脚架/独脚架/画架，这张证只能在现场售票窗口买，线上买不到</strong>",
          "hours": "官网 Seasonal & Holiday Schedule 原文：<strong>March – November: Open Daily, 10:00 a.m. to 5:00 p.m.</strong>（1–2 月与 12 月上半月才有周二闭馆）。<strong>末次入场为闭馆前 1 小时</strong>。九月下旬至十月底<strong>没有任何闭馆日</strong>，最近的闭馆日是 11 月 26 日感恩节。<strong>Halloween Nights 为 10 月 2 日–11 月 7 日部分夜晚的独立售票活动，不影响白天开放</strong>",
          "parking": "无自有停车场。<strong>沿 22nd Street 与 Brown Street 靠监狱这一侧路边免费且不限时</strong>（官方说明）；22nd St & Fairmount Ave 有商业停车场（Parkway Corporation，267-765-3665，价格需电询）。多条 SEPTA 公交可达；距 Philadelphia Museum of Art 台阶仅 744 米",
          "walk": "路边停车到售票入口 <strong>50–200 米 / 1–3 分钟</strong>；入口到最里侧牢房区约 <strong>300 米</strong>，走的是单向动线。<strong>多数人在场内停留约 2 小时，认真拍要留 3 小时以上</strong>"
        },
        "notes": [
          "<strong>三脚架政策已核实且很明确</strong>：一般门票不含三脚架权利，<strong>必须在现场售票窗口另买 $10/人/日的器材通行证</strong>（三脚架、独脚架、画架）。会员全年免票且器材证免费。<strong>长曝光是这里的全部意义，请务必买这张证</strong>",
          "<strong>手电筒、打火机、小刀、胡椒喷雾一律禁入</strong>，持枪证也不例外，且场内不代保管。这条对摄影者的实际影响是：<strong>不能带手电或补光棒进场</strong>，暗部只能靠曝光解决",
          "需要提前预约的情况：<strong>拍模特（不论专业业余）、穿服装、带道具、拍无游客的空场、进非开放区域，或使用三脚架/独脚架/画架以外的任何器材</strong>——这些都算私人拍摄，须走官方 Photography and Filmmaking 流程",
          "<strong>禁止灵异调查</strong>（含 EVP 录音等设备），官方明文。这里没有官方鬼故事项目",
          "<strong>建筑处于半废墟状态：地面高低不平、石棱锋利、有铅基漆危害公告</strong>。无空调无暖气，十月室内阴冷。<strong>禁凉鞋、拖鞋、露趾鞋与高跟鞋</strong>，请穿硬底鞋",
          "<strong>五座万圣节鬼屋（Dark Tides、Big Top Terror、Machine Shop、Nightmares、The Crypt）就搭在真实牢房里</strong>，布景与灯光桁架从九月起进场。<strong>官方从未声明白天动线会因此缩减，也从未声明不会——十月白天是否会撞见现代布景未能从官方渠道确认</strong>。要绝对干净的废墟就赶在 10 月 2 日前来",
          "<strong>十月周末的白天人流会明显高于平日</strong>（万圣节季带来整体客流上升）。想拍无人走廊，工作日 10:00 一开门就进，先跑最远的牢房翼再往回走"
        ],
        "images": [
          {
      ...
      },
      {
        ...
        "en": "Boathouse Row",
        "score": 4.5,
        "tldr": "6,400 盏 LED 已确认每晚运行、日落亮到日出。蓝调窗口 9/25 18:55–19:25、10/22 18:15–18:45。",
        "tags": [
          {
            "t": "完全免费",
            "c": "free"
        ...
        "highlights": [
          "15 栋维多利亚式船屋沿 Schuylkill 河东岸排开，隶属 <strong>Schuylkill Navy</strong>——1858 年成立，是<strong>全美最古老的业余体育管理机构</strong>，至今仍在运作。其中 Undine Barge Club 出自 Frank Furness 之手，Sedgeley Club 那栋带着 Turtle Rock Lighthouse",
          "<strong>灯光的来历比灯光本身更有意思：1979 年灯光设计师 Ray Grenald 提议给船屋描边，起因是当时市里正在认真讨论把这些破败的维多利亚建筑拆掉。</strong>他的逻辑是——夜里发光的东西没人舍得拆。这套灯赶在教宗 John Paul II 1979 年访费城前点亮，此后船屋再没被提起拆除",
          "<strong>灯光状态已核实为正常运行。</strong>2023 年 3 月整套系统下架，耗资 <strong>210 万美元</strong>全面重建，2024 年 3 月 7 日重新点亮：<strong>6,400 盏 LED，1,600 万种配色，可做渐变、流动与闪烁效果</strong>，总控设在 Lloyd Hall，<strong>每晚自动日落亮起、日出关闭</strong>。Fairmount Park Conservancy 2026 年公开表示重新点亮以来已执行超过 170 次定制灯光请求",
          "<strong>但那 1,600 万种配色是双刃剑：任何个人、企业与团体都能付费预订当晚颜色。</strong>你可能兴冲冲赶到河边，看到的是一整排粉色（有家人办过性别揭晓派对）、Eagles 的午夜绿或某个公益日的主题色。<strong>出发当天查 Instagram @boathouserowlights，这是唯一的官方预告渠道</strong>",
          "<strong>Fairmount Dam 就在船屋街下游 265 米处，把这一段河面拦成一潭静水</strong>——这是倒影能成立的物理原因，也是这里比任何城市水景都更容易拍到镜面的技术前提"
        ],
        "photo": "夜景 <strong>5/5</strong>，建筑 <strong>4/5</strong>，人像 <strong>3/5</strong>。费城的头号夜景，免费、24 小时、灯光确认在运行、河面天生平静。扣分因白天看是一排普通的维多利亚房子，且周末对岸机位开不进车。",
        "shots": [
          {
            "name": "Fairmount Dam Fish Ladder 西岸（官方指定观赏点，招牌机位）",
            "desc": "<strong>这就是 2024 年官方重新点灯仪式的观礼位置，press release 原文称其「directly across the river from Boathouse Row」。</strong>船屋街走向 285.5°、全长 400 米，而这个点几乎正落在其垂直平分线上，距离 269–314 米——<strong>几何上是最正的「对岸」</strong>。#1/Lloyd Hall 在方位 63°，#15 在方位 337°。<strong>关键窗口：灯在日落瞬间自动亮起，所以蓝调是 9/25 18:55–19:25、10/22 18:15–18:45</strong>（民用暮光分别到 19:20 与 18:39，再往后 5–10 分钟天空仍有余色）。<strong>这 30 分钟是全天唯一能同时拍到「LED 轮廓清晰」与「天空还是钴蓝而非死黑」的时段，错过就只剩黑底照片。</strong><strong>20–24mm 收全排；70–135mm 挑三四栋做密集图案。</strong>曝光：三脚架 f/8、ISO 100、<strong>4–15s</strong>；想把任何涟漪抹平就拉到 <strong>30–60s</strong>。手持极限是 f/1.8、ISO 6400、1/15s，能出但画质掉一档。<strong>拍倒影务必包围曝光</strong>：水中亮度通常比建筑本身低 1.5–2 EV。",
            "park": [
              39.968378,
              -75.184204
            ],
          ...
          },
          {
            ...
            "desc": "<strong>#15 在方位 4.8°（205 米）、#1 在方位 76.5°（414 米）</strong>，视角比 Fish Ladder 更斜，能把船屋压成前后叠错的一串，<strong>适合 85–200mm 的压缩构图，不适合拍全排</strong>。时段同上（9/25 18:55–19:25、10/22 18:15–18:45）。<strong>白天这个点也值得来一次</strong>：船屋临河立面朝西南（约 195°），本季从早上 08:15 一直被照到日落，<strong>16:00–18:00 是最好的白天光</strong>，暖光正面打在维多利亚山墙与门廊上。晚十月来的话，河岸坡地的彩叶正好可以当前景。",
            "park": [
              39.968378,
              -75.184204
            ],
          ...
          },
          {
            ...
            "desc": "<strong>这是唯一能贴近拍船屋建筑细节的机位</strong>：铁艺阳台、鱼鳞瓦、Turtle Rock Lighthouse 的石塔。视线沿 Kelly Drive 向西北（约 290°）。<strong>建议 07:00–09:00</strong>——Schuylkill 是全美最强的赛艇训练河之一，<strong>清晨会有大学与俱乐部队伍扛着单双人艇下水</strong>，35–85mm 拍「扛艇下坡」这类纪实画面，比拍空建筑有意思得多。<strong>注意：从这一侧看不到那条完整的发光轮廓</strong>，灯是给对岸看的，站在灯下什么都拍不到。夜景请务必过河。",
            "park": [
              39.968378,
              -75.184204
            ],
        ...
        "access": {
          ...
          "hours": "<strong>河岸与步道 24 小时开放。灯光每晚自动在日落亮起、日出关闭</strong>（Fairmount Park Conservancy 与 Philadelphia Parks & Recreation 2024 年新闻稿原文：「Each night the lights are automatically scheduled to go on at sunset and off at sunrise」）。<strong>另有第三方来源称灯只亮到约 22:00，与官方口径矛盾，本次以官方为准，但深夜拍摄前请留个心</strong>",
          "parking": "东岸：<strong>Lloyd Hall / Art Museum Trailhead 免费停车场</strong>（39.96838, -75.18420）是最方便的落脚点。西岸机位：<strong>工作日可沿 MLK Jr. Drive 行车并在路侧停靠；周末（3/28–11/29 每周六 07:00 至周一 07:00）MLK Drive 对机动车封闭</strong>，闸门夜间上锁，只能步行或骑行进入",
          "walk": "从 Lloyd Hall 停车场到东岸机位 <strong>100–300 米 / 2–5 分钟</strong>。<strong>到西岸 Fish Ladder 机位没有近路：Fairmount Dam 不可通行，必须绕 MLK Drive Bridge 过河，全程约 1.5 公里 / 20 分钟</strong>（该桥 2025 年 9 月完成 2,000 万美元大修重开，新增 10.5 英尺共享步道）。<strong>工作日直接把车开到 MLK Drive 一侧最省事</strong>"
        },
        "notes": [
          "<strong>当晚灯光颜色不可预期</strong>，1,600 万配色可被付费预订，重新点亮以来已执行 170 多次定制灯光。想拍经典白色轮廓，<strong>出发当天先看 Instagram @boathouserowlights</strong>",
          "<strong>周末（3 月 28 日–11 月 29 日）MLK Drive 对机动车封闭，周六 07:00 至周一 07:00</strong>，10 月 10–12 日为加长封闭。<strong>封路期间步道照常通行但车开不进去，且闸门夜间上锁</strong>——周末想拍蓝调只能提前步行/骑行进场，并安排好返程",
          "<strong>10 月 24–25 日 Head of the Schuylkill Regatta</strong>：那个周末 MLK Drive <strong>反而不封车</strong>，但船屋街一带是全年最拥挤的时候，停车基本无望。换个角度看，这也是唯一能拍到河面上成百条赛艇的两天",
          "<strong>三脚架在公共步道上无明令禁止</strong>，但 MLK Drive 与 Kelly Drive 都是快速车道，<strong>务必留在步道内，不要占用自行车道</strong>——这条 SRT 步道夜间仍有大量骑行者",
          "<strong>倒影靠 Fairmount Dam 拦出的静水，通常镜面级</strong>，但清晨与傍晚有赛艇下水会打碎水面。真要绝对平静，等 19:30 之后",
          "西岸 MLK Drive 一侧夜间人少、照明稀疏。<strong>不建议单人携带显眼器材深夜久留</strong>，东岸 Lloyd Hall 一侧人流与照明都好得多",
      ...
      },
      {
        ...
        "highlights": [
          "1812–1815 年由 <strong>Frederick Graff</strong> 建成，是费城最早的市政供水泵站，也是<strong>美国最早以水为主题的大型公共工程之一</strong>。希腊复兴柱廊被刻意做成神庙样子，用来掩盖里面轰鸣的水轮机——<strong>19 世纪的市政基础设施居然是当年费城的头号旅游景点</strong>，Charles Dickens、Mark Twain 都来看过",
          "<strong>它退休后的经历比服役期更离奇</strong>：1909 年停止供水，<strong>1911–1962 年被改成费城水族馆</strong>，之后又变成 <strong>Kelly Natatorium 游泳池直到 1972 年</strong>。2003 年才成为费城水务局的环境教育中心。现在你走的柱廊底下，先后是泵房、鱼缸和泳池",
          "<strong>建筑群朝河一侧的法线约 292°（西北），本季从下午 14:00 一直受光到日落</strong>——这是它比美术馆好拍的地方：<strong>整个黄金时段都在正面光里</strong>，而且它是白色的，暖光上去发色极好。九月 25 日 17:30–18:54、十月 22 日 16:45–18:12 是最佳段",
          "<strong>Fairmount Dam 就在建筑西北 265 米处</strong>，拦出的静水面既给水厂做倒影，也是 Boathouse Row 倒影的来源。西侧的 Fairmount Dam Fish Ladder 是一条可站的鱼道结构，正好是同时收下水厂、水坝与船屋的位置",
          "<strong>秋色主体在 Kelly Drive 与 Waterworks Drive 沿河一线</strong>。费城的峰值在 10 月 16–24 日到万圣节之间，<strong>晚九月来只有全绿，晚十月来这一段是本区最值得拍彩叶的地方</strong>——连接水厂与美术馆的 North / Central / South Cliffside Path 三条崖径全在这条带上"
        ],
        "photo": "建筑 <strong>4.5/5</strong>，风光 <strong>3.5/5</strong>，人像 <strong>3.5/5</strong>。免费、24 小时可拍外景、黄金时段正面受光、有水有倒影有柱廊，性价比是本区最高的。扣分因主体不大、室内解说中心开放日很窄、且从上方俯瞰的最佳角度会被树遮挡。",
        "shots": [
          {
            "name": "North Cliffside Path 高处俯瞰柱廊（最经典角度）",
            "desc": "<strong>这条崖径在美术馆与水厂之间的岩壁上，是唯一公开可及的高机位</strong>，能同时看到柱廊屋顶线、前方拦河静水与远处的 Boathouse Row。<strong>时段 16:30–日落</strong>：9/25 17:30–18:54、10/22 16:45–18:12，太阳方位 232–270°，正面照亮朝河立面。<strong>24–70mm，横构图收全景；70–200mm 单挑柱廊与水面倒影的对称</strong>。日落后到民用暮光结束（9/25 至 19:20、10/22 至 18:39）可拍蓝调版本，此时 Boathouse Row 的 LED 已亮，能一起收进画面。<strong>树叶遮挡随季节变化，请沿崖径来回走 50 米找开口</strong>。",
            "park": [
              39.966344,
              -75.18356
            ],
          ...
          },
          {
            ...
            "desc": "<strong>栈道在建筑北侧、贴着水面</strong>，向东南（约 146°）拍柱廊侧面与桥孔，向西北（约 310°）就是 297 米外的 Boathouse Row。<strong>这是唯一能把机身压到几乎贴水拍倒影的位置</strong>，16–24mm 广角低机位，把石砌拱券与水中倒影做上下对称。<strong>建议同为 16:30–日落</strong>；清晨（07:00–08:30）此处是逆光，但雾天时水面蒸腾配柱廊剪影很好看。栈道木板雨后极滑。",
            "park": [
              39.966344,
              -75.18356
            ],
          ...
          },
          {
            ...
            "desc": "<strong>视线 109.4°，距水厂 449 米，距 Fairmount Dam 185 米</strong>。<strong>这是唯一能把「拦河坝＋水厂柱廊＋山上的美术馆」三层叠进一张的机位</strong>，也是 19 世纪版画里最常见的那个视角。<strong>时段：日落前一小时到日落</strong>（9/25 17:54–18:54、10/22 17:12–18:12），太阳在你背后偏右，把三个主体全部正面点亮。<strong>70–200mm 压缩层次是关键</strong>，广角会让三者都变小。同一机位转身向北就是 Boathouse Row 的招牌位，<strong>一趟能拍两个点</strong>。注意周末 MLK Drive 封车（详见 Boathouse Row 条目）。",
            "park": [
              39.968378,
              -75.184204
            ],
        ...
        "access": {
          ...
          "hours": "<strong>外景与崖径 24 小时开放。</strong>室内 Interpretive Center 官网原文：<strong>Wednesday – Saturday 10:00am – 5:00pm</strong>，<strong>周日、周一、周二及节假日闭馆</strong>。周六 13:00–16:00 另有动手活动。<strong>注意它是本区唯一在周三开门的室内场馆</strong>——周三美术馆与 Barnes 都关门，这里是唯一的室内替代。你的窗口内正在展出 <strong>John Brady 摄影展（2026-09-19 至 2027-01-08）</strong>",
          "parking": "<strong>Philadelphia Museum of Art 停车楼的 Water Works Drive 入口离这里最近</strong>（$9/小时）；或用 <strong>Lloyd Hall / Art Museum Trailhead 免费停车场</strong>（39.96838, -75.18420）。西岸 Fish Ladder 机位见 Boathouse Row 条目的 MLK Drive 说明。地址：640 Waterworks Drive（Lower Level），215-685-0723",
          "walk": "Water Works Drive 停车层到柱廊约 <strong>150 米 / 3 分钟</strong>；<strong>从美术馆台阶顶下到水厂 309 米 / 6 分钟，但要走石阶下坡，返程是上坡</strong>；Lloyd Hall 停车场到 Boardwalk <strong>185 米 / 3 分钟</strong>；到西岸 Fish Ladder 需绕 MLK Drive Bridge，约 <strong>1.5 公里 / 20 分钟</strong>"
        },
        "notes": [
          "<strong>室内开放日是周三至周六，只有四天，且和另两家馆完全错开。</strong>想同时进美术馆和这里，只有周四、周五、周六可行；周三则是「只有这里开门」的日子",
          "<strong>三脚架在户外步道与崖径上无明令禁止</strong>；室内解说中心的三脚架政策<strong>未能从官方渠道确认</strong>，空间不大且有互动展品，建议手持",
          "<strong>柱廊南端的 Engine House 现为 Cescaphe at the Water Works 婚宴场地</strong>，周末常有整场包场活动，<strong>届时部分露台与南花园会被围起来</strong>。外部柱廊与栈道通常仍可通行，但会有大量婚礼人流",
          "<strong>崖径与栈道的木板、石阶在雨后与霜后极滑</strong>，且部分路段无护栏、直落水面。带三脚架下坡请一步一测",
          "<strong>不要试图走上 Fairmount Dam</strong>，那是运行中的拦河堰，也不要下到坝下岩石区——水位受上游泄流影响会突然变化",
          "这一带是 Schuylkill River Trail 的主干，<strong>清晨与傍晚跑者和骑行者密度很高</strong>，在窄处架机器会挡道，请靠一侧",
          "晚十月拍彩叶的话，<strong>Kelly Drive 沿线与三条 Cliffside Path 是本区最好的取景带</strong>，但费城峰值只持续 7–10 天，出发前查宾州 DCNR 每周秋色报告"
        ],
        "images": [
          {
      ...
      },
      {
        ...
        "score": 4.5,
        "tldr": "台阶顶回望 Parkway 是日落机位，18:00 后最佳；$30、周二周三闭馆，周五延到 20:45 且 17:00 后随心付。",
        "tags": [
          {
            "t": "成人 $30",
            "c": "paid"
        ...
        "highlights": [
          "1928 年落成，Horace Trumbauer 事务所主持。<strong>实际主笔是 Julian Abele——宾大建筑系首位非裔毕业生</strong>，在种族隔离年代他的名字长期不被署上图纸。这栋米黄色 Minnesota dolomite 希腊复兴巨构（本地人叫它 \"the Greek garage\"）最反常识的一点是：<strong>它的两翼山花上装着彩釉赤陶群像</strong>，按古希腊神庙本来的样子上了色——多数人以为古典建筑就该是素白的，这里告诉你不是",
          "<strong>东入口 72 级台阶因《Rocky》(1976) 成为全球最知名的一段楼梯</strong>。A. Thomas Schomberg 为《Rocky III》(1982) 制作的青铜像原本立在台阶顶端，博物馆以「那是电影道具不是艺术品」为由要求移走，几番拉扯后 <strong>2006 年定位在台阶底东北侧的平台</strong>——所以现在拍「人站在台阶顶举手」和「拍雕像」是两个分开的机位，中间要走 87 米",
          "<strong>台阶顶端往东南望，方位 134.8°，Washington Monument（138 米）、Swann Memorial Fountain（1,152 米）、City Hall 塔楼（2,010 米）三点依次落在同一条线上，实测偏差不到 1°。</strong>City Hall 2024 年完成 685 万美元 LED 立面照明改造（222 盏 Color Kinetics ReachElite，装在周边 11 栋楼顶），四面与钟塔全部打亮，蓝调时段是这条轴线尽头唯一的亮点",
          "室内主目标是 <strong>Great Stair Hall</strong>：通高门厅，顶部天窗，楼梯平台上立着 Augustus Saint-Gaudens 的镀金《Diana》（原为 Madison Square Garden 塔顶风向标）。另有 Van Gogh《Sunflowers》、Picasso《Three Musicians》、以及一整座从东京搬来的茶室 <strong>Sunkaraku（「聴閑楼」）</strong>",
          "<strong>坏消息：整栋楼夜间只有东立面被打光。</strong>博物馆设施主管 2024 年对《Inquirer》说得很直白——这栋 1928 年的建筑电网供电能力不足以照亮 63.5 万平方英尺的外墙，<strong>现在照亮东露台立面的那两组灯具是租的，每周约 $7,000</strong>。想拍「整栋楼夜景通亮」的网图，那是特殊活动临时租灯拍的，日常没有。另外 Perelman Building 附楼自疫情起关闭至今未重开，别按旧攻略跑过去"
        ],
        "photo": "建筑 <strong>5/5</strong>，城市风光 <strong>4.5/5</strong>，人像 <strong>4.5/5</strong>。台阶＋Parkway 轴线是费城的头号城市构图，外景完全免费且 24 小时可站；扣分因周二周三闭馆吃掉两天、室内禁三脚架、夜间只有东立面有光。",
        "shots": [
          {
            "name": "台阶顶端回望 Parkway（本区第一招牌）",
            "desc": "<strong>视线 134.8°，这是日落机位不是日出机位</strong>。太阳在你右后方，整条 Parkway 与 City Hall 塔楼西北面被正面暖光照亮。<strong>9/25 用 17:45–18:54，10/22 用 17:00–18:12</strong>；随后 <strong>9/25 18:54–19:25、10/22 18:12–18:45</strong> 是蓝调版本，City Hall 立面灯已亮而天空还留着钴蓝，这是全天最好的一张。<strong>焦段 70–200mm 是首选</strong>，把 2 公里外的 City Hall 塔楼压缩放大到与前景 Washington Monument 等量级；24–35mm 拍「台阶＋两侧旗阵＋消失点」的开阔版。站位就在台阶最上一级的中轴，台阶宽、人多，广角很难避开游客，<strong>长焦其实更容易出干净画面</strong>。三脚架在露台上无明令禁止，但人流量大，独脚架更实际。",
            "park": [
              39.966344,
              -75.18356
            ],
          ...
          },
          {
            ...
            "desc": "<strong>视线 314°，正对建筑东立面（法线 134°），所以这是上午机位</strong>。东南立面从日出一直被照到太阳转过 224° 方位为止（9/25 约 15:00，10/22 约 15:20）。<strong>最好的是 07:30–09:00</strong>：太阳方位 96–108°，偏离立面法线 26–38°，低角度斜射把彩陶山花和柱列的浮雕层次全部勾出来；10:00–11:00 太阳转到正面（方位 125–141°）反而变平。<strong>24–70mm，从 Washington Monument 喷泉基座这一侧起拍</strong>，138 米距离刚好能把喷泉群雕当前景、建筑与台阶完整收进后景。此时台阶上跑步的人也最多，是拍「Rocky 朝圣者」的时段。",
            "park": [
              39.966344,
              -75.18356
            ],
          ...
          },
          {
            ...
            "desc": "雕像面朝西北，正对台阶，<strong>所以雕像正脸在下午到日落被照亮，上午是背光</strong>。<strong>建议 16:00–18:00</strong>，35–85mm 低机位仰拍，让举起的双拳顶在天空上、把台阶与建筑山花放在背景。这里全天排队合影，<strong>要拍到无人的雕像只有 07:00 前</strong>（但那时是背光，只能拍剪影或侧轮廓）。雕像基座前的铜制脚印与围栏很容易入画，压低机位可以避掉。",
            "view": [
              39.965139,
              -75.179296
            ]
          },
          {
            ...
            "desc": "门厅顶部天窗，<strong>11:00–14:00 顶光最强</strong>（9/25 正午太阳高度 49.3°，10/22 39.1°），此时天窗光柱能落到楼梯与《Diana》镀金像上。<strong>16–24mm 超广仰拍</strong>，站门厅正中；85–135mm 单拍《Diana》。<strong>官方规则原文只有一句「Flash is not permitted — but take lots of pictures!」</strong>，也就是常设展厅欢迎手持拍摄。<strong>建议 f/2–f/2.8、ISO 1600–3200</strong>，门厅光比常超过 8 EV，包围 3 张做 HDR 更稳。坐标取自 OSM 建筑面中心，为<strong>推算</strong>值。",
            "view": [
              39.965574,
              -75.18092
            ]
        ...
        "access": {
          "book": "<strong>不强制预约</strong>，官方鼓励线上买定时票以免排队，现场也可购。philamuseum.org。周五 Pay What You Wish 的免费/自定价票<strong>需线上预约</strong>，热门时段会满",
          "ticket": "<strong>成人 $30，65 岁以上 $28，持证学生 $14，18 岁及以下免费</strong>。票<strong>连续两天有效</strong>，含 Rodin Museum。<strong>每周五 17:00–20:45 Pay What You Wish</strong>（官方 2026-09-03 发稿宣布延长至 2027-06-25）；<strong>每月第一个周日全天 Pay What You Wish</strong>。台阶、露台、Rocky 雕像等全部外景<strong>免费，24 小时可站</strong>",
          "hours": "官网原文：<strong>Monday 10am-5pm；Tuesday Closed；Wednesday Closed；Thursday 10am-5pm；Friday 10am-8:45pm；Saturday 10am-5pm；Sunday 10am-5pm</strong>。末次入场一般为闭馆前 30 分钟。<strong>周二、周三闭馆是本区最硬的约束</strong>",
          "parking": "自有停车楼 1 Anne d’Harnoncourt Drive（另有 Water Works Drive 入口）与 West Terrace 露天位，<strong>$9/小时；周五 17:00–21:00 $10 一价到底</strong>。会员 $4/小时（首小时免费）。公交：SEPTA 7、32、38、43、48、49 路",
          "walk": "停车楼到东露台台阶顶约 <strong>250 米 / 4 分钟</strong>（含电梯）；台阶顶到 Rocky 雕像 <strong>87 米</strong>；台阶顶到 Eakins Oval / Washington Monument 机位 <strong>138 米 / 3 分钟</strong>；台阶顶到 Fairmount Water Works <strong>309 米 / 6 分钟</strong>（下坡有石阶）"
        },
        "notes": [
          "<strong>摄影规则</strong>：官方展厅政策页只写了一句「Flash is not permitted — but take lots of pictures!」，常设展厅允许个人非商业手持拍摄。<strong>三脚架、独脚架与自拍杆按业界通行做法应属禁止，但这一条未能在现行官网页面上找到明文</strong>，请按禁止准备并做好被劝阻的预期",
          "<strong>特展可能单独禁摄</strong>。你的窗口内 <strong>Van Gogh’s Sunflowers 与 Workshop of the World 展至 10 月 11 日</strong>，A Nation of Artists 展至 2027 年 7 月 5 日。<strong>特展厅（尤其含外借作品的）是否允许拍摄未能从官方渠道确认</strong>，以现场标识为准",
          "<strong>Perelman Building 附楼自疫情起关闭、至今未重新开放</strong>，馆方仍在研究其去向；Frank Gehry 的东露台地下扩建计划因财务压力无限期搁置。旧攻略里的这两项都不要照抄",
          "夜景只有东立面被租来的灯具打亮（约 $7,000/周），<strong>整栋楼不亮</strong>。要拍夜景请把机位放在东侧（台阶/Eakins Oval 一侧），西侧与北侧夜间基本是黑的",
          "超过规定尺寸的背包与雨伞须寄存。台阶石面在雨后很滑，且台阶是真正的公共空间——晨跑者、婚纱、毕业照全在这里，不要指望有清场的机会",
          "这里是 Parkway 各类游行与集会的固定终点，<strong>遇到活动日东露台会被舞台与围栏占用</strong>，出发前查一下 phila.gov 的活动与道路封闭公告"
        ],
        "images": [
          {
      ...
      },
      {
        ...
        "highlights": [
          "<strong>关于摄影政策的重要更正：Barnes 并没有禁止拍照。</strong>barnesfoundation.org 的 Plan Your Visit 页面原文是「Photography for personal use is allowed, unless otherwise posted. No flash, tripods, or selfie sticks.」——<strong>个人用途的非闪光手持拍摄是允许的，禁的是闪光灯、三脚架与自拍杆</strong>。网上有若干旅游站点声称「画廊内一律禁摄」，与官网原文冲突，<strong>以官网为准</strong>",
          "Albert C. Barnes 靠一种叫 Argyrol 的银基消毒药水发财，1922 年建立基金会。藏品密度惊人：<strong>181 幅 Renoir、69 幅 Cézanne、59 幅 Matisse、46 幅 Picasso</strong>，外加 Matisse 专为原馆绘制的巨型壁画《The Dance》",
          "<strong>它的展陳方式是全世界独一份，也正是它难拍的原因。</strong>Barnes 遗嘱规定所有作品必须按他生前排定的「ensembles」（组群）悬挂，<strong>墙面上没有任何说明标签</strong>，油画与非洲雕塑、宾州德裔铁艺、家具混在同一面墙上密密排列。拍单件作品要在密集画面里找干净背景，比在普通美术馆难得多",
          "<strong>2012 年从 Merion 郊区搬到 Parkway 上，是美国博物馆史上最有争议的一次搬迁</strong>——Barnes 遗嘱明确禁止藏品移动，法院最终推翻了它。新馆由 <strong>Tod Williams Billie Tsien</strong> 设计：外覆以色列内盖夫石灰岩，核心是一座通高的 <strong>Light Court</strong>；原 Merion 展厅的房间尺寸与开窗位置被逐间复制进新壳里，所谓「a gallery in a garden, a garden in a gallery」",
          "<strong>拍建筑比拍藏品划算。</strong>南侧朝 Parkway 的前庭有一片浅反射水池与一道刻纹石墙，这是全馆最上镜的部分，而且<strong>在馆外，免费，不受闭馆日影响</strong>"
        ],
        "photo": "建筑 <strong>4/5</strong>，藏品翻拍 <strong>2.5/5</strong>，人像 <strong>3/5</strong>。Light Court 与前庭水池是干净的现代建筑题材；扣分因展厅密集排布几乎无法取得简洁构图、照度低又禁三脚架、周二周三闭馆。<strong>如果你只有一天且要拍室内，选 Eastern State 不选这里。</strong>",
        "shots": [
          {
            "name": "南前庭反射水池与刻纹石墙（免费外景）",
            "desc": "<strong>视线向北偏东，主体是内盖夫石灰岩墙面与浅水池</strong>。石墙的横向刻纹靠斜射光才立体：<strong>9/25 用 17:00–18:40，10/22 用 16:15–18:00</strong>，此时太阳方位 232–265°，从西侧低角度扫过墙面。24–35mm，<strong>机位压到贴近水面拍倒影对称</strong>；50–85mm 拍刻纹与光影的抽象重复。正午顶光时石墙彻底变平，不要在中午来这一机位。这里在收费区之外，随时可拍。",
            "park": [
              39.960634,
              -75.172707
            ],
          ...
          },
          {
            ...
            "desc": "<strong>通高 Light Court 顶部为漫射天窗，全天光质柔和均匀，没有「最佳钟点」</strong>——这既是优点（何时来都一样）也是缺点（永远不会有戏剧性光柱）。<strong>建议 11:00 开门即入</strong>，这是唯一人少的时段（会员 10:00 已进场，但人数有限）。16–24mm 拍空间尺度，35–50mm 拍 ensembles 整面墙。<strong>禁三脚架，所以 f/1.8–f/2.8＋ISO 1600–6400＋机身防抖是唯一方案</strong>，展厅照度按油画保护标准压得很低。拍整面墙时注意油画表面反光，<strong>侧移半步换角度比调曝光有效</strong>。坐标取自 OSM 建筑面中心，为<strong>推算</strong>值。",
            "view": [
              39.960634,
              -75.172707
            ]
        ...
        "access": {
          "book": "<strong>建议线上预约定时入场票</strong>（barnesfoundation.org / 215.278.7000），周末与特展期强烈建议提前几天；现场票房也售票但不保证有位。<strong>大学生 $5 票只能电话购买（215.278.7000），线上买不到</strong>。每月首个周日的 <strong>PECO Free First Sunday</strong> 免费但<strong>必须注册</strong>，容量有限，<strong>放票时间是活动前一个周四 10:00</strong>（如 10 月 4 日那场，10 月 1 日 10:00 放票）",
          "ticket": "<strong>成人 $30，长者 $28，大学生 $5（电话购），13–18 岁 $5，12 岁及以下免费</strong>。含特展，<strong>连续两天有效</strong>。ACCESS/EBT 卡与费城 pre-K–12 教师免费。<strong>每月第一个周日免费（需注册）</strong>。南前庭与外墙<strong>免费</strong>",
          "hours": "官网原文：<strong>Thursday–Monday 11am – 5pm</strong>，会员 10:00 起入场。<strong>周二、周三闭馆</strong>（官网未列在营业表内，第三方与官网 hours 模块口径一致）。另闭 7 月 4 日、感恩节、圣诞节——均在你的窗口之外",
          "parking": "自有停车场入口在 <strong>Pennsylvania Avenue（20 街与 21 街之间）</strong>，GPS 输 2020 Pennsylvania Avenue。<strong>访客 $12/4 小时以内，超时每小时 $2</strong>；会员 $10/4 小时。共 60 车位，含充电桩。周边车库 $10–15 起",
          "walk": "停车场到入口约 <strong>120 米 / 2 分钟</strong>；到南前庭水池机位 <strong>100 米以内</strong>。步行到 Swann Memorial Fountain <strong>350 米 / 5 分钟</strong>，到 Philadelphia Museum of Art 台阶 <strong>819 米 / 11 分钟</strong>（沿 Parkway 直线）"
        },
        "notes": [
          "<strong>三脚架、独脚架、自拍杆、闪光灯全部禁止</strong>，官网明文。素描与笔记只允许用石墨铅笔、本子不超过 9×12 英寸",
          "<strong>「unless otherwise posted」这一句是关键漏洞</strong>：含外借作品的特展厅通常单独挂禁摄标识。你的窗口内特展是 <strong>Noguchi to Asawa: Designing Postwar America（2026-09-20 至 2027-01-10，Roberts Gallery）</strong>，以及 Just Us（至 10 月 12 日）、Sky Hopinka: Red Metal Dust（至 2027-01-18）。<strong>这几个特展厅是否允许拍摄未能从官方渠道确认</strong>，进门先看标识",
          "<strong>展厅拥挤时会被要求停止拍照、素描与记笔记</strong>，官方明确写了这是为了维持人流，不是针对你。周末与免费日最容易触发",
          "墙上没有标签，藏品信息要靠自家 App「Barnes Focus」——这意味着<strong>你几乎不可能靠现场信息判断哪件值得拍</strong>，有明确目标的话请提前在官网藏品库里做功课",
          "所有包件进门须查验；武器、刀剪、气雾罐一律禁入",
          "斜对面 2100 Benjamin Franklin Parkway 是新开的 <strong>Calder Gardens</strong>，与 Barnes 两个入口相距约 480 米、需横穿 Parkway。本次未做核实，若你对现代建筑与雕塑有兴趣可自行加查"
        ],
        "images": [
          {
      ...
      },
      {
        ...
        "highlights": [
          "1924 年落成，<strong>Alexander Stirling Calder</strong> 雕塑、Wilson Eyre 设计水型。三尊仰卧的原住民人像分别象征费城三条水系：Delaware River、Schuylkill River、Wissahickon Creek，所以它也叫 <strong>Fountain of the Three Rivers</strong>",
          "<strong>本区最有意思的一条冷知识：Parkway 轴线上站着祖孙三代 Calder。</strong>City Hall 塔顶的 William Penn 像出自祖父 Alexander Milne Calder，这座喷泉出自父亲 Alexander Stirling Calder，Philadelphia Museum of Art 里悬挂的活动雕塑《Ghosts》出自儿子 Alexander Calder。<strong>本地人管这三件叫「the Father, the Son, and the Holy Ghost」</strong>，而且三件正好落在同一条 134.8° 轴线上",
          "<strong>喷泉状态是本条目最大的变量。</strong>2023 年一次人为破坏打坏了驱动中央水柱的主泵，2025 年 9 月剩下的泵也坏了，池子被抽干、全面停摆。城市投入数十万美元做「major」级系统翻修，<strong>2026 年 5 月 15 日费城市政官方账号发布喷泉已恢复通水</strong>。<strong>但中央水柱是否恢复到应有高度未能从官方渠道确认</strong>——这道柱子历史上原本喷 50 英尺，近年只到约 25 英尺"
        ],
        "photo": "建筑与雕塑 <strong>4/5</strong>，城市风光 <strong>3.5/5</strong>，人像 <strong>3/5</strong>。完全免费、24 小时可站、正好在 Parkway 轴线中点上是最大优势；扣分因主体较小、周边车流嘈杂、且喷水与否直接决定这张照片成不成立。",
        "shots": [
          {
            "name": "水池北侧沿 Parkway 轴线向东南拍 City Hall",
            "desc": "<strong>视线 135.9°，与 Parkway 轴线一致，City Hall 塔楼在 859 米外正对你</strong>。<strong>这是日落与蓝调机位</strong>：太阳在右后方（方位 256–270°），塔楼西北面正面受光。<strong>9/25 用 17:45–18:54 加 18:54–19:25 蓝调；10/22 用 17:00–18:12 加 18:12–18:45 蓝调</strong>。<strong>70–200mm 把 City Hall 压缩到与前景雕像等量级</strong>，让喷泉人像做前景、塔楼填满背景开口，这是本机位唯一值得拍的构图；24–35mm 会把塔楼缩成一个小点。<strong>若喷泉在喷，1/8–1/2s 慢门让水丝化</strong>，需要 ND8 或等日落后再拍。针脚取 OSM 喷泉本体节点，实际站位在水池外沿，绕圈自选角度。",
            "view": [
              39.957937,
              -75.170592
            ]
          },
          {
            ...
            "desc": "<strong>视线 313.9°，指向 Philadelphia Museum of Art（1,152 米）</strong>，右手边是 Cathedral Basilica of Saints Peter and Paul 的铜绿穹顶。<strong>这是上午机位</strong>：太阳在东南方（方位 90–140°），从背后照亮穹顶与美术馆立面。<strong>建议 08:00–10:00</strong>，此时车流也是全天最少。35–70mm 把 Parkway 两侧成排的万国旗当作引导线；<strong>Parkway 的旗阵是这条大道最容易被忽略的构图元素</strong>，低机位仰拍能让旗子在画面上缘形成节奏。同一节点，站位换到水池南沿即可。",
            "view": [
              39.957937,
              -75.170592
            ]
        ...
        "access": {
          "book": "不需预约",
          "ticket": "<strong>免费</strong>",
          "hours": "<strong>24 小时开放，全年无闭</strong>。<strong>但喷泉本身是季节性运行</strong>：费城 Parks & Recreation 的口径是「通常四月底或五月初开始通水，至少运行到十月中下旬，视是否出现冰点温度可延续到感恩节」。<strong>晚九月几乎肯定在喷；10 月 20 日之后正好落在关水的临界区间，出发前请查 @philaparkandrec 或电询 Parks & Rec</strong>",
          "parking": "Logan Circle 周围无专用停车场，路边为需求定价表位；建议用 Barnes Foundation 停车场（2020 Pennsylvania Avenue，$12/4 小时）步行过来，或搭地铁 BSL 到 Race–Vine 站。<strong>Logan Circle 是环形交叉口，车速快，横穿务必走人行横道</strong>",
          "walk": "Barnes Foundation 停车场到水池 <strong>350 米 / 5 分钟</strong>；沿 Parkway 步行到 Philadelphia Museum of Art 台阶 <strong>1,152 米 / 15 分钟</strong>，到 City Hall <strong>859 米 / 11 分钟</strong>"
        },
        "notes": [
          "<strong>喷泉是否在喷是这一条目成败的唯一变量。</strong>不喷水时它只是三尊卧像加一个空水泥池，摄影价值掉一半以上。<strong>晚十月来的话把它当作「可能拍不到」来安排</strong>",
          "<strong>中央高柱自 2023 年起就有问题，2026 年大修后是否恢复原有高度未能从官方渠道确认。</strong>网上大量「50 英尺水柱」的照片是历史影像，别按那个预期构图",
          "Logan Circle 的外圈人行道与八处 ADA 缘石坡道在 2025 年 12 月至 2026 年 5 月 19 日期间施工，<strong>按官方工期已在你的窗口之前完工</strong>，但 2026 年是费城 250 周年，Parkway 全年活动密集，<strong>遇到活动日水池周边可能被围栏或舞台占用</strong>",
          "水池外沿可坐可站，涉水在夏天是本地惯例，但秋季水温低且官方并不鼓励。<strong>不要为了机位跨进池内</strong>",
          "这里三面被 Four Seasons、Free Library、Franklin Institute 和 Cathedral 围住，<strong>公开可及的高处机位没有</strong>——网上的俯拍多来自酒店客房或私人办公楼，不要按那些图去找位置",
          "夜间 Logan Circle 车流不断、照明良好，治安尚可，但仍是开放环形路口，<strong>架三脚架请远离路缘</strong>"
        ],
        "images": [
          {
