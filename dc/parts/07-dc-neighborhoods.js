  ...
  callouts: [
    ...
    },
    {
      ...
      html: '<p>本区六个点里，C&amp;O Canal、Frederick Douglass NHS、Meridian Hill Park 三处属 NPS，理论上受停摆影响；' +
        ...
        '也就是说 <strong>10 月 1 日的财年切换不会触发停摆，整个 9 月底至 10 月底的行程窗口完全被覆盖</strong>。' +
        '下一个悬崖是 12 月 11 日，与本次无关。</p>'
    },
    {
      type: 'warn',
    ...
    },
    {
      ...
      html: '<p><strong>日出日落（Washington DC，按 NOAA 算法计算，与官方发布值差异在 ±3 分钟内）：</strong></p>' +
        ...
        '夏令时到 11 月 1 日才结束，本行程窗口内全程 EDT。</p>' +
  ...
  spots: [
    {
      ...
      shots: [
        ...
        },
        {
          ...
          desc: '<strong>无 OSM 实体，地图无针脚。</strong>位置在 Wisconsin Avenue 跨运河桥往西，' +
            ...
            '光线同上：正午顶光进沟，傍晚打立面。这段建议放在行程末尾当机动项，' +
            '到现场看围挡再决定要不要花时间。',
      ...
      access: {
        ...
        hours: 'Georgetown Waterfront Park <strong>24 小时开放</strong>。' +
          ...
          'NPS 现况页显示 Georgetown Visitor Center 为「Open」，' +
          '<strong>但其具体每日开放钟点未能从官方渠道确认</strong>，需要盖 Passport 章的话请先致电 301-739-4200',
        parking: '<strong>不建议开车。</strong>Georgetown 街边咪表周一至周六收费（费率以现场标牌为准，' +
          '<strong>2026 年具体价格未能核实</strong>）；车库首选 Washington Harbour（3000 K St NW）与 ' +
          'Georgetown Park（3222 M St NW），日间约 $20–30/天量级。' +
          'Waterfront Center 车库（38.90285, -77.06342）离滨水公园最近',
        walk: 'Metro <strong>Foggy Bottom–GWU 站（蓝/橙/银线）</strong>步行到滨水公园约 <strong>1.3 公里 / 16 分钟</strong>；' +
          '<strong>Rosslyn 站</strong>走 Key Bridge 过河约 <strong>1.2 公里 / 15 分钟</strong>，' +
          '<strong>而且过桥时本身就是拍 Georgetown 天际线的免费机位</strong>。' +
    ...
    },
    {
      ...
      access: {
        ...
        parking: '阶梯底部就是一个小型停车场（M Street 与 Canal Road 交口附近），车位极少；' +
          '实际建议停 Waterfront Center 车库（38.90285, -77.06342）或用 Metro',
        walk: '从滨水公园东端走到阶梯底部约 <strong>900 米 / 12 分钟</strong>；' +
          '<strong>Rosslyn 站过 Key Bridge 到阶梯底部约 800 米 / 10 分钟，是最近的地铁路径</strong>。' +
      ...
      notes: [
        ...
        '10 月 31 日前后是这里全年人最多的时候（万圣节朝圣），' +
          '<strong>如果行程落在 10 月下旬且想要空镜，务必赶清晨</strong>',
    ...
    },
    {
      ...
      highlights: [
        ...
        '<strong>1944 年 8 月到 10 月的 Dumbarton Oaks Conference 就在这栋楼里开</strong>——' +
          ...
          '也就是说，你在深秋午后拍的这片草坪与台地，正是联合国蓝图定稿时窗外的景',
        '园内共有 <strong>12 座喷泉</strong>，原设计是活水常流、溢流后进雨水管网。' +
          ...
          '<strong>10 月 31 日前的常规季应当运行，信心中偏高；但请把它当作加分项而不是行程前提</strong>',
      ...
      access: {
        book: '<strong>必须提前在 Eventbrite 购定时票，现场没有售票点、没有候补、没有 standby。</strong>' +
          '票为定时入场，持票可在标注时间到 17:30 之间入园；每户每日限 10 张；售出不退' +
          '（仅当园方自行闭园时例外）；<strong>不可再次入场</strong>。2026 年季票已全部售罄',
        ticket: '常规季（3/1–10/31）<strong>$15/人</strong>，2 岁及以下免费。' +
          '冬季（11/1–12/31）<strong>免票但仍需提前预约</strong>',
        hours: '<strong>常规季 3 月 1 日–10 月 31 日：周二至周日 14:00–18:00，17:30 停止入场，周一及联邦假日闭园。</strong>' +
          '<strong>2026 年额外闭园日：10 月 8、9、10 日</strong>（当日不售票且季票不认）。' +
          '冬季 11/1–12/31：14:00–17:00，16:30 停止入场，同样周一与联邦假日闭园。' +
          '1/1–2/28 全季闭园。<strong>注意 10 月 12 日的 Columbus Day / Indigenous Peoples\' Day 是周一，本就闭园，不额外冲突</strong>',
        parking: '<strong>无自有停车场。</strong>周边 R Street、32nd Street、31st Street 是居民区路边停车，' +
          '大部分路段有 Residential Permit Parking 时段限制（非居民通常限停 2 小时），' +
          '<strong>看清每一根标杆</strong>。开车来建议停 Georgetown 商业区车库后步行上坡',
        walk: '游客入口在 <strong>1703 32nd Street NW</strong>（32nd &amp; R Street 路口附近）。' +
          '从 M Street 商业区走上来是持续爬坡约 <strong>1.1 公里 / 15–18 分钟</strong>；' +
          '<strong>Metro 无邻近站</strong>，Dupont Circle 站（红线）步行约 1.9 公里 / 25 分钟，' +
          '或搭 Wisconsin Avenue 走向的 Metrobus 到 Q Street 后步行 600 米'
      },
      notes: [
    ...
    },
    {
      ...
      shots: [
        ...
        },
        {
          ...
          desc: '<strong>Space Window 位于中殿南侧的中层高侧窗（clerestory），' +
            ...
            'ISO 1600–6400，f/2.8–f/4，机身防抖全开——<strong>实务上你只能手持</strong>。',
      ...
      access: {
        book: '自助参观<strong>建议提前在 cathedral.org 或 tix.cathedral.org 购票</strong>，' +
          '现场也可买但热门时段会满。<strong>塔楼攀登与幕后导览必须提前预约</strong>，' +
          '按讲解员排班开放，名额少。20 人以上团体必须提前申请',
        ticket: '<strong>自助参观（Self-Guided Sightseeing）：成人 $15，5–12 岁儿童 $10，' +
          '学生与长者周一至周三 8 折。</strong>票含 Bloomberg Connects 数字导览、主层与地下层、' +
          '各展览，以及 <strong>Tower Observation Gallery「when available」——即观景廊是否开放逐日不定，不保证</strong>。' +
          '导览类：Guided Spotlights Tour <strong>$20 / 儿童 $15</strong>（含 1 小时讲解，之后可继续自助参观）；' +
          'Behind the Scenes Tour <strong>$35</strong>；<strong>Bell Tower Climb $50</strong>' +
          '（爬 333 级到中央塔的鸣钟室，全程 70–90 分钟，有身高与年龄限制）。' +
          '<strong>参加礼拜与私人祈祷永远免费</strong>',
        hours: '<strong>官方原文：「Our sightseeing hours vary day-to-day to accommodate the wide range of activities ' +
          'and ministries offered at the Cathedral. Your ticket is valid for the hours posted that day.」</strong>' +
          '实际常见为 <strong>10:00–17:00 或 11:00–17:00，17:00 准时清场（closes promptly at 5 pm）</strong>。' +
          '<strong>周日：官方明确写「Touring is not available during Sunday services」</strong>，' +
          '周日基本不售自助参观票；<strong>某个特定周日午后是否放开参观未能确认，必须逐日查 cathedral.org 的日历</strong>。' +
          '<strong>Garth 中庭与 All Souls Memorial Garden 因中央塔工程封闭，官方称「不早于 2026 年晚秋」重开</strong>',
        parking: '<strong>场地内有地下车库</strong>（由 Atlantic / asgpark.com 运营），' +
          '入口在 Wisconsin Avenue、Woodley Road 南侧那个红绿灯处，' +
          '<strong>开放 06:00–23:00，限高 7 英尺 6 英寸</strong>，各层电梯旁有无障碍车位与缴费机（收现金与信用卡）。' +
          '<strong>周日礼拜时段免费</strong>。<strong>具体费率官方只给 PDF 且注明随时调整，2026 年数值未能核实</strong>。' +
          '周边住宅区路边车位极少',
        walk: '<strong>没有邻近地铁站。</strong>最近是红线 Woodley Park–Zoo/Adams Morgan 站，步行约 1.5 公里 / 20 分钟且是上坡；' +
          '更实用的是 Wisconsin Avenue 走向的 Metrobus（D82 Wisconsin Avenue–Foggy Bottom 线在座堂门口设站，' +
          '站点坐标 38.92969, -77.06651）。车库电梯到访客入口约 <strong>150 米 / 3 分钟</strong>；' +
          '<strong>访客入口在从 Wisconsin Avenue 正对立面时的左前方，玻璃电梯对面</strong>'
      },
      notes: [
    ...
    },
    {
      ...
      shots: [
        {
          ...
          desc: '<strong>本条目的招牌机位，而且最佳时段被开门时间锁死了。</strong>' +
            ...
            '<strong>17:00 闭园，日落是 19:02（9/25）／18:21（10/22），山顶的日落与蓝调你拍不到，别做计划。</strong>' +
        ...
        },
        {
          ...
          desc: '<strong>官方规则原文：「Photography is permitted, but the flash must be off ' +
            ...
            '意味着<strong>你只能带一机一镜进去，其余留车上或访客中心</strong>——' +
            '请提前决定好那支镜头。' +
      ...
      access: {
        book: '<strong>房屋内部只能通过 ranger 导览进入。</strong>官方强烈建议预约：' +
          ...
          '<strong>每张票收 $1 不可退的预约服务费，最晚需提前一天预约，最早可提前 6 个月</strong>。' +
          '未被预约掉的余票在访客中心免费先到先得，<strong>但热门时段经常提前很久就订满</strong>。' +
          '11 人以上团体必须预约（1-877-559-6777，提前至少一周，同样 $1/人，学校团体统一 $10）',
        ticket: '<strong>免门票、免入园费</strong>。唯一的钱是 $1/张的网上预约服务费',
        hours: '<strong>房屋导览仅在周二至周六进行</strong>（<strong>即周日与周一无法进屋</strong>）。' +
          '标准场次：<strong>9:00、12:15、13:15、15:00、15:30，以及仅 4–10 月加开的 16:00 场</strong>，' +
          '每场 30 分钟、上限 10 人。<strong>另有每天 11:30 的一场 Grounds Tour（户外，15–20 人）</strong>。' +
          '访客中心 <strong>4–10 月 9:00–17:00</strong>（11–3 月 9:00–16:30）。' +
          '<strong>提醒：NPS 导览页最后更新于 2025 年 8 月，2024 年曾因人手不足一度缩到每周只开三天，' +
          '2026 年秋是否仍为周二至周六未能确认，出发前请致电 771-208-1499</strong>',
      ...
      notes: [
        ...
        '<strong>关于 Anacostia 的实用建议（只讲操作，不讲刻板印象）：</strong>' +
          ...
          '且<strong>全年 17:00 就闭园，你不会在天黑后还留在附近</strong>。' +
    ...
    },
    {
      ...
      access: {
        ...
        ticket: '<strong>免费</strong>',
        hours: '<strong>5 月至 10 月 05:00–24:00；11 月至次年 4 月 05:00–21:00。</strong>' +
          '<strong>整个 9 月底至 10 月底的行程窗口都适用「开到午夜」这一档</strong>，' +
          '这是本区唯一能从容拍夜景的点位。无闭园日',
