    ...
    "spots": [
      {
        ...
        "photo": "城市／街拍 <strong>3.5/5</strong>，夜景 <strong>4/5</strong>，运动 <strong>4/5</strong>（Brennan’s Wave），风光 <strong>2/5</strong>，人像 <strong>3.5/5</strong>。<strong>这一组的价值不在单张照片的上限，而在「题材种类」——它给了你本区其他七个点位都给不了的东西：流水动态、夜景霓虹、手工雕刻细节与街头人文。</strong><strong>而它最大的实用价值是抗天气：全部题材都是近景，烟霾、阴天、下雨都能拍。</strong>扣分在于它毕竟是一座小城市，<strong>天际线本身没什么可看的，你拍的是细节与瞬间，不是气势。</strong>",
        "shots": [
          {
        ...
        "access": {
          "book": "不需预约。旋转木马<strong>无需预订，直接买票乘坐</strong>（非公众开放时段可整场租用，与你无关）",
          "ticket": "<strong>街区、桥、Caras Park、河滨与 Brennan’s Wave 全部免费。</strong><strong>A Carousel for Missoula：单次乘坐 $0.50–1.50</strong>（<strong>残障人士永远免费</strong>）；<strong>进入建筑观看与拍摄不需要买票，礼貌起见建议买一次坐一圈。</strong><strong>Dragon Hollow 儿童游乐区免费。Wilma Theater 除演出票外不对外开放内部参观。</strong>木马旁有礼品店（收益用于木马维护）",
          "hours": "<strong>A Carousel for Missoula：每日开放，9 月至次年 5 月 11:00–17:30；6 月至 8 月 11:00–19:00。你的 9/22–9/23 适用 11:00–17:30，已核实。</strong><strong>请注意 17:30 关门早于黄金时段，无法在好光下拍到运转中的木马——正确安排是 15:00–17:30 先拍木马，再去河边与桥上拍傍晚与蓝调。</strong><strong>官方另提示：秋季人手有限，偶尔会因私人活动提前关闭，建议致电 406-549-8382 确认当天营业。</strong><strong>Caras Park、Higgins Avenue Bridge、河滨步道与 Brennan’s Wave 均为 24 小时开放的公共空间，无门禁——所以蓝调与夜景拍摄没有时间限制。</strong><strong>Wilma Theater 按演出日程运营，无固定参观时间</strong>",
          "parking": "<strong>旋转木马有专用停车场</strong>（从 Ryman Street 直接开入，101 Carousel Drive）。<strong>市区另有街边计时停车与多处停车场</strong>，<strong>9 月下旬平日傍晚（18:00 之后）市区街边停车通常已停止收费且车位充足</strong>（<strong>具体收费截止时间未能从官方渠道确认，请看路边计时器立牌</strong>）。<strong>本景点的最佳策略是：停一次车，全程步行完成四个机位。</strong><strong>从这里沿 Clark Fork 南岸的 Kim Williams Trail 步行 20–25 分钟即可到 M Trail 步道口</strong>，<strong>可以避开大学校内的平日停车费（见上一个景点）</strong>",
          "walk": "<strong>四个机位全部在步行 10 分钟范围内</strong>：Caras Park／旋转木马到 Brennan’s Wave 约 <strong>2–3 分钟</strong>；到 Higgins Avenue Bridge 桥面约 <strong>3–4 分钟</strong>；桥南头到 Wilma Theater <strong>1 分钟</strong>；再到 Missoula County Courthouse 约 <strong>5 分钟</strong>。<strong>全程平坦铺装、无爬升、轮椅可通行。</strong><strong>建议预留 3–4 小时（15:00 到旋转木马，20:20 拍完蓝调）</strong>，<strong>这是本子地区唯一一个可以「停一次车、走一整个下午到夜里」的点位</strong>"
        },
        "notes": [
          "<strong>这一组是本子地区最强的「坏天气 / 烟霾日」方案，请把它当成保险。</strong>全部题材都是近景与夜景，<strong>烟霾、阴天、下雨都能拍；AQI 超过 100 时把整个下午与傍晚挪到这里，是本区最有效的补救</strong>",
          "<strong>时间顺序不要弄反：旋转木马 17:30 关门，而黄金光与蓝调在 18:00–20:20。</strong><strong>正确顺序是 15:00–17:30 旋转木马 → 16:30–18:30 Brennan’s Wave 拍动作 → 19:20–20:20 桥上与 Wilma 拍蓝调夜景。</strong>这三段在时间上刚好接续",
      ...
      },
      {
        ...
        "access": {
          ...
          "hours": "<strong>步道全年开放（“Open year-round”），无门禁、无关门时间</strong>，<strong>可以放心拍到民用暮光 20:05 之后再下山。</strong>这是本区少数几个「时间上完全自由」的点位，<strong>也因此是唯一能拍到蓝调城市灯火的机位</strong>。<strong>大学校园本身的开放与停车管制时间见下一栏</strong>",
          "parking": "<strong>【这一条对你的日期有直接影响，请注意】</strong>步道口停车场在 University of Montana 校内的 Campus Drive 上（Aber Hall 对面、球场后方）。<strong>Destination Missoula 的官方提示原文：“Parking for The ‘M’ Trail and Mount Sentinel summit via Hellgate Ridgeline requires payment during weekday university operating hours, while weekend parking is free. Spaces are limited, so plan to arrive early and be sure to check current parking regulations and enforcement times before your visit.”</strong><strong>即平日校方办公时间内需付费，周末免费。而 9/22 是周二、9/23 是周三，都是学期中的平日——所以你需要付费停车。</strong><strong>好消息是：你的最佳拍摄时段是 17:30 之后，而校内停车执法通常在下午晚些时候结束（具体截止时间未能从官方渠道确认）。请到场看停车场立牌，或用校内的自助缴费机／App 按小时付费。</strong><strong>车位有限，官方建议早到。</strong><strong>另一个稳妥选择：把车停在市区（Higgins Avenue 一带有免费或廉价街边停车），沿 Clark Fork 南岸的 Kim Williams Trail 步行约 20–25 分钟到步道口</strong>，顺便完成了上面第三个机位",
          "walk": "<strong>到混凝土「M」：单程 3/4 英里、爬升 620 英尺、13 个之字弯，上行 20–30 分钟（带三脚架与长焦按 30–35 分钟），下行 15–20 分钟。往返约 1.8 英里／1–1.5 小时（不含拍摄）。</strong><strong>坡度陡但路面好、全程有成形步道与长椅，官方评级中等。</strong><strong>到 Mount Sentinel 山顶：单程 1 3/4 英里、爬升 1,916 英尺、往返 3.8 英里／3–4 小时，本次行程不建议</strong>——「M」的视野已经足够，多出来的 1,300 英尺换不到成比例的画面提升。<strong>傍晚场次建议整体预留 3 小时（17:15 到停车场，20:15 回到车上）</strong>"
        },
        "notes": [
          ...
          "<strong>平日校内停车需付费，而 9/22 与 9/23 都是学期中的平日。</strong>车位有限、官方建议早到；<strong>执法截止时间未能从官方渠道确认，请到场看立牌。</strong><strong>替代方案：停在市区、沿 Kim Williams Trail 步行 20–25 分钟过来</strong>",
      ...
      },
      {
        ...
        "highlights": [
          "<strong>这是本区第二个《Yellowstone》实景地，而且和 Chief Joseph Ranch 相反——它是你真的可以走进去、坐下来的那一个。</strong><strong>剧中第四季季终集，John Dutton 请 Jamie 的生父 Garrett Randall 吃饭，说了那句 “Best Salisbury steak in Montana. You enjoy. Because you never know which meal will be your last.”——那场戏就是在这里拍的。</strong><strong>有意思的是，剧播出之前 Salisbury steak 根本不在 Glen’s 的菜单上</strong>；现在它作为 <strong>“Famous Yellowstone Salisbury Steak”</strong> 常驻午餐菜单，<strong>约 $13，可选薯条、洋葱圈或土豆泥</strong>。<strong>而且牛肉不是外购的——店主 Glen 自家牧场养的</strong>（“all the beef served at Glen’s … is homegrown on the owner Glen’s ranch”）。这一条比任何布景都更接近剧里那个世界的真实版本",
          "<strong>它本身是一家开了半个多世纪的家庭小馆，这才是它真正好拍的地方。</strong>Montana 官方旅游部门的描述是：<strong>“Glen’s Cafe is a small log cabin in the heart of Florence, that’s been family owned and operated since 1972.”</strong><strong>一栋原木小屋、1972 年至今、一家人经营——它不需要靠电视剧来成立，剧只是让更多人找到了它。</strong>当地评价里反复出现的两件事是<strong>派（pie）和咖啡</strong>，不是牛排。<strong>如果你只点一样，本地人会让你点派。</strong>",
        ...
        "photo": "人文／街拍 <strong>3.5/5</strong>，美食 <strong>3/5</strong>，风光 <strong>1/5</strong>。<strong>请按「一家路边小馆」而不是「一个景点」来对待它——这里没有风光可拍，一栋原木小屋的外立面、一面挂着剧组照片的墙、一盘牛排和一块派，就是全部内容。</strong>给 2.5 分是因为它在人文题材上确实成立：<strong>1972 年至今的家庭小馆有真实的生活质感，室内的暖色调与窗光很好用，而且它是本区唯一一个你可以「进入」的剧集实景地。</strong><strong>这一条请保持轻量：给它 45 分钟、吃一顿饭、拍三五张，就够了。</strong>",
        "shots": [
          {
            "name": "店外原木小屋立面与招牌",
            "park": [
        ...
        "access": {
          "book": "<strong>不需预约，也不接受预订</strong>（多个信息源一致标注 “Reservations: Not accepted”）。<strong>直接进店等位即可</strong>；这是一家小馆子，午市（11:30–13:00）可能需要等几分钟。电话 <strong>406-273-2534</strong>",
          "ticket": "<strong>进店免费</strong>，消费即门票。<strong>人均 $10–20；Famous Yellowstone Salisbury Steak 约 $13；仿剧中款 T 恤约 $30。</strong><strong>接受信用卡、借记卡、NFC 移动支付，也收支票（很 Montana 的一件事）</strong>",
          "hours": "<strong>周一至周五 09:00–15:00；周六、周日部分信息源标注 08:30–14:00，另一些标注同为 09:00–15:00。</strong><strong>你的 9/22（周二）与 9/23（周三）都是平日，营业时间 09:00–15:00，已核实。</strong><strong>所以「9/22 落地后直奔 Florence 吃午饭」在时间上完全成立</strong>（MSO 到店 26 英里／35 分钟）。<strong>但请注意它 15:00 就关门，是本区最早关门的点位之一——如果第一天上午耽误了，第二天从 Darby 折回来会很别扭（Darby 到 Florence 约 44 英里／55 分钟）。</strong><strong>周末营业时间的两种口径未能统一，但与你的日期无关。出发前建议打 406-273-2534 确认当天营业</strong>——小馆子会因家庭原因临时休息",
        ...
        "notes": [
          ...
          "<strong>09:00–15:00，15:00 关门，这是硬约束。</strong><strong>把它放在 9/22 落地当天的午饭是唯一顺畅的安排</strong>（MSO 出发 35 分钟）；<strong>顺路可以把 St. Mary’s Mission（再往南 8 英里，11:00–15:00）串在同一段里</strong>",
          ...
          "<strong>请对它的摄影分量保持现实预期</strong>：这是一栋路边的原木小屋，<strong>没有任何风光成分</strong>。它的价值在于「你可以真的坐进那场戏里」，<strong>而这恰恰是 Chief Joseph Ranch 给不了你的</strong>",
      ...
      },
      {
        ...
        "highlights": [
          "<strong>先交代取舍理由，因为派活时让在 Lolo Pass 与 Bitterroot 峡谷走廊之间二选一。我选 Bitterroot 走廊，理由是四条，每一条都指向你的具体日期：</strong><strong>（一）Lolo Pass 访客中心周二与周三全天关闭</strong>——官方原文 <strong>“open Thursday-Monday from 8:30 AM–4:00 PM PST … It will be closed all day Tuesday and Wednesday.”</strong>而<strong>你的两天恰好就是 9/22 周二与 9/23 周三，两天都闭馆</strong>（24 小时卫生间仍开放）。<strong>（二）方向不对。</strong>Lolo Pass 在 Missoula 西南 53 英里、US-12 上，<strong>往返 2 小时 20 分钟，而且是朝西——与你之后往东南去 Butte 的方向完全相反</strong>；Blodgett 在 Hamilton 西侧，就在谷地主线上。<strong>（三）烟源全在 Lolo Pass 西侧。</strong>2026 年 Missoula 县最主要的外来烟源是<strong>Lolo Pass 西北的 Moose Mountain Fire</strong>，以及 US-12 沿线 Lowell 一带的<strong>Grotto（3,849 英亩，0% 控制，单日增长 2,649 英亩）、Cascade（6,800 英亩）、Three Links、Wolf Creek</strong> 一串火。<strong>把一个下午投给全区烟霾概率最高的走廊，是本区最差的时间分配。</strong><strong>（四）树种时机也不站在 Lolo Pass 这边</strong>：那里的秋色主角是中低海拔的 <strong>western larch</strong>，<strong>盛期 10 月上中旬，9/22 还是绿的</strong>（详见前面的秋色提醒）",
        ...
        "shots": [
          ...
          },
          {
            ...
            "desc": "<strong>坐标为 OSM Blodgett Creek Trailhead 实体节点（已核实），即停车场本身。</strong><strong>这是「不想爬那 1.5 英里」或者「到得太晚来不及上去」时的替代方案，下车即到。</strong>从谷口向西（上游）看，两侧岩壁向内收拢，<strong>是拍「峡谷之门」这种对称构图的位置</strong>，且有 Blodgett Creek 的溪水可以做前景。<strong>【这里的最佳时段与观景点恰好相反，是清晨——而且 9/22 有一个特殊的几何巧合值得知道。】</strong><strong>Blodgett Canyon 大致东西走向、谷口朝东开；而 9/22 秋分日太阳从方位 88.8°（几乎精确的正东）升起。也就是说这一天的日出光会沿着峡谷的轴线径直射进谷内，把整条峡谷从谷口一路照亮到深处的谷头。</strong><strong>这种「日出光正轴灌入峡谷」的情形一年只在春分与秋分前后各出现几天，而你正好赶上。</strong><strong>实际到位时间请算 07:50–09:00</strong>——虽然 07:23 就日出了，但谷地东侧的 Sapphire Mountains 仰角约 3.9°，<strong>阳光真正进到谷口要等到约 07:50（推算）</strong>。24–70mm 拍对称的谷口，70–200mm 压深处被光照亮的岩壁。<strong>清晨溪谷气温会更低，且这里是熊活动地形，请带熊喷雾。</strong>"
          }
        ],
        "access": {
          "book": "不需预约",
          "ticket": "<strong>免费</strong>。Blodgett Overlook Trail 与其停车场<strong>不属于收费游憩区，无需日间使用费，也不需要任何通行证</strong>（与 Lake Como 不同）",
          "hours": "<strong>步道与停车场无门禁、无关门时间，官方标注最佳季节 5–10 月，9/22–9/23 完全在季节内。</strong><strong>但请注意「无门禁」不等于「一定能进」——这一带的真正变量是火情封路。</strong><strong>2026 年已知的 Bitterroot NF 封闭令是针对 Nature Grove Fire 的：Forest Order 01-03-02-26-09 封闭 NFSR 75（自 MT-38 Skalkaho Highway 起至 NFSR 720 路口）、NFSR 720 与 NFSR 711，另 Black Bear Campground 与 714 号路关闭，效期自 7 月 27 日至 12 月 31 日。这些路全在谷地东侧的 Sapphire Mountains 一带，与西侧的 Blodgett（FS 735／736）不是同一批路，因此现有封闭令不影响本景点——已核实。</strong><strong>但 Cooper（310 英亩，0% 控制）与 Scimitar（334 英亩，0% 控制）两把火仍在 Bitterroot NF 的荒野区内燃烧，新增封闭随时可能发布。出发当天必须复查官方 alerts 页：fs.usda.gov/r01/bitterroot/alerts，或致电 Bitterroot NF 总部 406-363-7100 / Darby Ranger Station 406-821-3913。</strong><strong>（作为对照：Lolo Pass Visitor Center 周二与周三全天关闭，你的 9/22 与 9/23 两天都闭馆，24 小时卫生间仍可用；该中心按太平洋时区运作。）</strong>",
        ...
        "notes": [
          "<strong>出发当天必须复查火情封路，这是本景点唯一的重大不确定项。</strong>现有封闭令（NFSR 75／720／711，针对 Nature Grove Fire）不涉及 Blodgett，已核实；<strong>但 Cooper 与 Scimitar 两把火仍在 Bitterroot NF 内 0% 控制，新增封闭随时可能发布。查 fs.usda.gov/r01/bitterroot/alerts 或 Watch Duty，或直接打 406-363-7100。</strong>",
          ...
          "<strong>Bitterroot 一带有灰熊与黑熊活动</strong>（Selway-Bitterroot Wilderness 内有灰熊，黑熊全森林常见）。<strong>整条步道都在熊活动区内，必须携带熊喷雾并放在随手可及处、出声行进</strong>；傍晚与清晨是熊最活跃的时段，而这恰好是你的拍摄时段。<strong>熊喷雾不能带上飞机（托运也不行），请在 Missoula 或 Hamilton 的户外店购买</strong>",
      ...
      },
      {
        ...
        "highlights": [
          "<strong>先回答派活时最关心的问题：两处在 9/22（周二）与 9/23（周三）都开门，没有一处已经季节性关闭。已核实。</strong><strong>Daly Mansion</strong> 的官方口径是<strong>「Summer Tour Season Hours (June – September)」</strong>——<strong>园区（grounds）每周 7 天 10:00–17:00 开放；导览团周二至周六 11:00–14:00；自助参观周二至周六 10:00 与 15:00 两场、周日全天 10:00–15:00。</strong><strong>St. Mary’s Mission</strong> 的官方口径是<strong>「Open Tue-Sat 11:00 am – 3:00 pm, Mid April to Mid October」（另一处官方表述为 4 月 15 日至 10 月 15 日），最后一团 14:00 出发。</strong><strong>9/22 是周二、9/23 是周三，两处的「周二至周六」窗口都覆盖到了。</strong>（附带两个与你无关但值得知道的日期：Daly Mansion <strong>10 月 14–23 日临时闭馆</strong>；另有第三方资料称其导览季 <strong>10 月 8 日</strong>结束，<strong>与官网「June–September」的夏季口径不完全一致，未能核实哪个为准</strong>——但这两个日期都在你的日期之后，不影响本次）",
          "<strong>为什么选 Daly Mansion 作为主推：它是本子地区体量最大、最完整的单体建筑，没有对手。</strong><strong>1910 年落成，24,000 平方英尺，乔治复兴式（Georgian Revival），24 间卧室、15 间浴室、7 座壁炉，坐落在 40 多英亩的草坪、花园与树木园中。</strong>设计者是 Missoula 建筑师 <strong>A.J. Gibson</strong>。<strong>摄影上它给你的是本区别处没有的三样东西：一个有对称轴与柱廊的正立面（可以拍严整的建筑几何）、一片有纵深的前草坪（可以退到足够远拍全景）、以及一批珍稀树木（可以拍局部与秋色）。</strong>官方对树木园的说法是<strong>「boasts one of the widest and rarest varieties of trees in the state of Montana」</strong>",
        ...
        "shots": [
          ...
          },
          {
            ...
            "desc": "<strong>坐标同大宅 OSM 实体。</strong><strong>【时间选择很关键，因为两种参观方式给你的拍摄条件完全不同】</strong><strong>导览团：周二至周六 11:00–14:00</strong>，但官方特别注明<strong>「based on volunteer tour guide availability」（取决于志愿者导览员是否在岗）</strong>——<strong>这意味着它可能临时没有。官方建议致电 406-363-6004 预约（“they are not required, but our tour guides look forward to knowing guests will be visiting”），虽非强制，但对摄影者来说值得打这个电话。</strong><strong>自助参观（self-guided）：周二至周六 10:00 与 15:00 两场</strong>，票价含自助手册。<strong>拍照的话请优先选自助场——你可以按自己的节奏停留、架机器、等光，而不必跟着导览团走。9/22 与 9/23 都是周二／周三，两种方式都可用。</strong><strong>【拍摄要点】室内是典型的高动态范围环境</strong>：深色木饰面 + 明亮的窗户，光比常在 6–8 档。<strong>请拍 RAW，并优先考虑「以窗户为光源的侧光人文构图」而不是硬拍全屋</strong>——让窗光从侧面打在壁炉、楼梯扶手或家具上，比开高 ISO 拍一整间屋子好看得多。<strong>镜头 16–35mm 拍房间全景（室内退不开，广角是必须的），35mm／50mm 定焦（f/1.4–2）拍陈设细节。</strong><strong>【器材限制】室内三脚架政策未能从官方渠道确认，请到场先问。若不允许，请依赖机身防抖 + 大光圈 + ISO 3200–6400，并把相机靠在门框或墙面上增加稳定。闪光灯请一律不要用</strong>——古董家具与织物对强光敏感，且直闪会毁掉室内的氛围光。<strong>【这是烟霾日的首选】</strong>室内完全不受能见度影响，<strong>AQI 超过 100 的那一天，把时间挪到这里是本区最有效的补救。</strong>"
          },
          {
            "name": "St. Mary’s Mission，Stevensville（顺路的第二选择）",
            "desc": "<strong>地址 315 Charlos Street, Stevensville（4th Street 西端）。此处无 OSM 实体节点，因此本机位省略 view 字段，地图上不会有针脚。参考：Stevensville 镇 OSM 中心为 46.51041, −114.09439。</strong><strong>【时段】开放 11:00–15:00（周二至周六），最后一团 14:00。所以你的可用时间被锁死在 11:00–15:00，没有早晚光可选。</strong><strong>在这个区间内，请优先选 11:00 一开门就进</strong>——此时太阳高度 33.5°／方位 133.4°（东南），<strong>仍是斜光；而 13:00–14:00 太阳升到 43° 的近顶光，白墙会拍成一片死白，木构的质感全部消失。</strong><strong>【拍什么】这里的价值全在细节，不在大场面，请调整拍法：</strong><strong>（一）Fr. Ravalli 手工雕刻的原始家具</strong>——35mm／50mm 定焦、大光圈、靠窗侧光，拍刻痕与木纹；<strong>（二）小教堂内部</strong>——16–35mm，同样用窗光做侧光，<strong>小教堂是本区唯一的宗教建筑内景题材</strong>；<strong>（三）1869 年那棵仍在结果的苹果树</strong>——70–200mm 拍带果的枝条，这是全区最有故事的一个近景细节；<strong>（四）建筑群与背后的 St. Mary’s Peak</strong>——官方说这座 Mission「stands in the shadow of St. Mary’s Peak」，<strong>用 70–200mm 把小教堂的白色尖顶与背后的 Bitterroot 山体压在一起，是这里唯一带风光成分的构图。但注意山在西侧，11:00–15:00 时段山体是正面光偏顶光，效果一般。</strong><strong>【实操建议】把它放在 9/22 从 MSO 南下的路上</strong>（MSO 出发 33 英里／45 分钟），<strong>与 Glen’s Café（Florence，再往北 8 英里）串成同一段，两者时间窗口也吻合。</strong><strong>门票 $10，5 岁以下免费；博物馆与美术馆免费。预约与团体（10 人以上）请电 406-777-5734。</strong>"
          }
        ],
        "access": {
          ...
          "hours": "<strong>Daly Mansion（官方「Summer Tour Season Hours (June – September)」原文口径）：</strong><strong>园区每周 7 天 10:00–17:00；导览团周二至周六 11:00–14:00（取决于志愿者在岗情况）；自助参观周二至周六 10:00 与 15:00、周日 10:00–15:00 全天。</strong><strong>9/22 周二与 9/23 周三均在开放窗口内，已核实。</strong>（另：<strong>10 月 14–23 日临时闭馆</strong>；第三方资料称导览季 10 月 8 日结束，<strong>与官网夏季口径不一致，未能核实</strong>，但均在你的日期之后）<strong>St. Mary’s Mission：周二至周六 11:00–15:00，最后一团 14:00，季节为 4 月中至 10 月中（另一处官方表述为 4 月 15 日至 10 月 15 日）。9/22 周二开放；9/23 周三亦在「周二至周六」窗口内。已核实。</strong><strong>【关键提醒】Daly Mansion 园区 17:00 关门，而当天日落 19:35、直射光到 18:59。也就是说黄金时段你一定在园外，这一点没有变通办法。</strong>",
        ...
        "notes": [
          "<strong>两处在 9/22 与 9/23 都开门，这是本景点最需要确认的一项，已核实。</strong>没有任何一处因为季节原因已经关闭——<strong>Daly Mansion 的夏季季节涵盖整个 9 月，St. Mary’s 的季节到 10 月中</strong>",
          ...
          "<strong>St. Mary’s Mission 的时间窗口很窄：11:00–15:00，最后一团 14:00。</strong><strong>它最合理的位置是 9/22 从 MSO 南下的途中（MSO 出发 45 分钟）</strong>，与 Glen’s Café（再往北 8 英里、15:00 关门）串成同一段；<strong>如果留到第二天从 Darby 折回来，会很别扭</strong>",
      ...
      },
      {
        ...
        "highlights": [
          ...
          "<strong>费用上有一个对你非常有利的时间点，必须知道：</strong>Bitterroot National Forest 的官方口径是<strong>日间使用费只在 Memorial Day 至 Labor Day 期间收取</strong>（$5／车／天或 $30／季）。<strong>2026 年的 Labor Day 是 9 月 7 日，而你是 9/22–9/23——费用已经停收了。</strong>官方对这个时段的完整描述是：<strong>“Lake Como Day Use Sites (Picnic Area, Trailhead, Beach, Boat Launch) = Day use fees no longer required, no services, ‘pack it in, pack it out’. Open year-round.”</strong><strong>翻译成实际情况：免费、全年开放、但没有任何服务——不清运垃圾、饮水与部分卫生间已关闭。所有垃圾必须自己带走。</strong>",
        ...
        "notes": [
          ...
          "<strong>湖面结冰不在本次窗口内的考虑范围</strong>，但<strong>清晨浅水边缘可能出现薄冰</strong>，踩上去会滑；沿岸的圆石在有霜时非常滑，扛三脚架时请注意",
      ...
      },
      {
        ...
        "highlights": [
          "<strong>先把最重要的结论放在最前面，因为它会改变你要不要来：剧中 Dutton 家那座巨大的原木主宅（lodge），站在公共道路上是看不到的。</strong>一位实地去过并写下记录的记者的原话是：<strong>“When I pulled off the highway, I was disappointed by how little of the ranch could be seen. From behind a large gate, I could see a sign welcoming visitors to the ‘Yellowstone Dutton Ranch.’ Beyond that, though, little was in view other than the tops of a few white barns, including one bearing the Dutton brand.”</strong><strong>也就是说，从路边你能拍到的全部内容是：那道石柱大门、门上的 “Yellowstone Dutton Ranch” 招牌、以及门后几座白色谷仓的顶部（其中一座带 Dutton 烙印图案）。主宅本身被门后那条两侧种满树的车道和 Bitterroot River 岸边的黑杨林完全挡住。</strong>这不是运气问题，是地形与植被决定的——<strong>换个角度也没有用</strong>",
          ...
          "<strong>唯一的进入方式是租那两间小木屋，而 2026 年这条路对你已经关闭了。</strong>可租的是 <strong>Fisherman Cabin</strong>（1916 年为主宅仆役所建，剧中第一、二季 Lee Dutton 的小屋，<strong>$1,600／晚</strong>含 4 人）与 <strong>Ben Cook Cabin</strong>（剧中第一季 Rip、第二季 Kayce 的小屋，<strong>$1,900／晚</strong>含 4 人），每加一人 $75／晚，<strong>房费含一次牧场与拍摄场景的导览</strong>（涵盖主宅 Great Room、厨房、前后廊、直升机坪、Armory、bunkhouse、马厩、墓地与河边多处场景）。<strong>但牧场官网首页明确写着 2026 年的接单范围是「March 15 through August 31, 2026」——住客季在 8 月 31 日已经结束，9/22–9/23 不可能有房。官网 Cabins 页此刻正在接的是 2027 年 3 月 1 日至 11 月 1 日的预订。</strong>也就是说，<strong>本次行程完全不存在进入牧场的可能，这一点已核实且没有余地</strong>（若要为将来打算：预订电话 406-821-0894，官网 chiefjosephranch.net 是<strong>唯一</strong>渠道，不上任何第三方平台，且需要提前约一年）",
      ...
      },
      {
        ...
        "notes": [
          ...
          "<strong>烟霾是这个点位的一票否决项。</strong>9 英里外的山在 AQI 超过 100 时基本拍不出对比。<strong>请在出发前一晚查 fire.airnow.gov，并记住烟霾的日变化规律恰好与你冲突——清晨是一天里烟最重的时候。若清晨能见度差，正确应对是改到 11:00–15:00 用长焦拍局部山脊，而不是硬拍全景。</strong>",
          ...
          "<strong>如果你想登顶：Trapper Peak Trail 单程约 4 英里、爬升约 3,700 英尺，往返 8 英里，属于全天强度</strong>，起点在 Darby 以南的 Troy Creek Road。<strong>这与本次两天的行程完全不兼容，本页所有内容都是谷底路边视角。</strong>另外 Selway-Bitterroot Wilderness 内<strong>有灰熊活动，任何进山徒步都必须带熊喷雾</strong>",
    ...
    "spots": [
      ...
      },
      {
        ...
        "access": {
          ...
          "ticket": "<strong>成人 $28；老人与 12–17 岁 $25；11 岁及以下 $10；儿童座椅另收 $10。</strong>官网注明 “Prices and times are subject to change”，并把最新价格指向 Buy Tickets 页的日历。<strong>从山下用长焦拍摄免费。</strong>",
      ...
      },
      {
        ...
        "access": {
          ...
          "hours": "<strong>明确判定：Livingston Depot Center 博物馆在 9/23–9/24 已关闭。</strong>官网原文 <strong>“Museum open Monday - Saturday 10am - 5pm，May 26 - September 4, 2026”</strong> 与<strong>“Last Museum Day September 4th, 2026”</strong>。FAQ 补充其常规闭季期为「大约 9 月中到次年 5 月初或中」。<strong>但车站外立面、庭院、遮荫公园与 Depot Rotary Park 全年无门禁、免费开放，所以本景点的摄影内容基本不受影响。</strong>办公室仍为<strong>周一至周五 10:00–16:00</strong>（电话 406.222.2300），<strong>老城街区 24 小时开放、全年可达</strong>",
      ...
      },
      {
        ...
        "access": {
          ...
          "hours": "<strong>两条路全年 24 小时通行，无门禁。</strong><strong>四处 FAS 官方标注均为 “Open: Jan 1 to Dec 31”，全年开放、不限时。</strong><strong>唯一的不确定项是 Carter’s Bridge 的 2026 年施工：单车道放行、9 英尺宽度限制、旗手或临时信号灯控制，MDT 称桥不封闭且项目预计年内完工，但 9 月 23 日是否已完工未能确认。出发当天务必查 511mt.net。</strong><strong>US-89 主线 2026 年未查到大型路面施工；East River Road 除 Carter’s Bridge 外未查到其他施工。</strong>",
    ...
    "spots": [
      ...
      },
      {
        ...
        "highlights": [
          ...
          "<strong>本区最核心的摄影事实：这里没有秋色、没有瀑布、没有野牛群，它给你的是「尺度」，而尺度恰恰是黄石园内所有机位共同的短板。</strong>树线在这一带大约 9,500–10,000 英尺，<strong>West Summit 一带全在树线以上，视野里连一棵成材的树都没有</strong>。没有树、没有建筑、没有栏杆，画面里就没有任何能告诉观众距离的东西——<strong>结果是照片会「显不出大」，这是本机位真正的难题，而不是光。</strong>解法在下面的机位说明里",
      ...
      },
      {
        ...
        "access": {
          "book": "<strong>不需预约</strong>，也没有任何预约渠道。<strong>如果你打算试一次，唯一有用的动作是提前打 Shoshone National Forest Clarks Fork Ranger District 问「FR 142 和瞭望台今天开不开」——因为官网那一页已经一年没更新，电话是唯一能拿到 2026 年真实状态的渠道。</strong><strong>该区与 Greybull、Wapiti 两区合署办公，地址 203A Yellowstone Avenue, Cody, WY，电话 (307) 527-6921，办公时间周一、周二、周四、周五 08:00–16:30 MT。</strong><strong>请特别注意它周三不上班</strong>——你 9/24（周四）要用的信息，<strong>如果想提前一天问，9/23 是周三，打不通；请在 9/22（周二）就打，或 9/24 当天早上开门后打。</strong>（备用：Supervisor’s Office 808 Meadow Lane Avenue, Cody，(307) 527-6241，周一至周五 08:00–16:30，但需预约到访。）现场没有手机信号，到了路口再想查是查不了的",
          "ticket": "<strong>免费。</strong>官方页面 Fee Site 栏为空，无入场费、无停车费。替代机位 Pilot-Index Overlook 的 layby 在 OSM 上标注 fee=no",
          "hours": "<strong>这是本景点的核心问题，官方口径有两条且不完全一致，请两条都按最严的理解：</strong><strong>（一）Shoshone National Forest 官方页（2026-09-05 复核）：页面状态标签 “Site Closed”，“Operational Hours: Day use only, open sunrise to sunset”，“Current Conditions: Closed for the 2025 Season”，页面 Last updated 2025 年 9 月 10 日——这一页在整个 2026 年从未更新过。</strong><strong>（二）Forest Service 另一官方页面：“The last 1/4 mile to the Fire tower is usually open 8am to 5pm.”</strong><strong>另有第三方记录称该闸门在 17:00–08:00 之间通常上锁。</strong><strong>结论：9 月 24–25 日按「已关闭」规划；即使开着，也只在 08:00–17:00 之间可能进得去。</strong><strong>2026 年是否开季、以及 2026 年的关闭日期，官方从未在这一页上发布过，这一项仍属未能确认。</strong><strong>但同区营地页面已经公布 2026 年 9 月 13 日收季（Beartooth Lake 与 Island Lake，页面 2026 年 7 月 6 日更新），而 2025 年 Clay Butte 的收季公告挂在 9 月 10 日——两个年份的节奏一致指向「9 月第二周收季」，所以 9/24–9/25 关着的可能性远大于开着。</strong><strong>唯一能问出 2026 年真实状态的渠道是电话：Clarks Fork Ranger District (307) 527-6921，注意它周三不上班（见 access.book）。</strong><strong>作为对照，替代机位 Pilot-Index Overlook 在 US-212 主路边，公路开放期内（2026 年 5 月 22 日 – 10 月 12 日）24 小时可用、无闸门。</strong><strong>10 月下旬那个备用窗口不用考虑本景点：10 月 12 日之后整条 Beartooth Highway 关闭，连主路上的替代机位都到不了。</strong>",
        ...
        "notes": [
          "<strong>把它当成「路过顺便看一眼路口有没有封」的加分项，不要写进当天的必到清单。</strong>路口在 US-212 的 44.93717, −109.62228，从 Cooke City 开过来约 <strong>21.3 英里／OSRM 39 分钟（实际 50–60 分钟）</strong>，<strong>而 Pilot-Index Overlook 就在再往西 1.6 英里的主路边——两个点顺路，看一眼路口不亏</strong>",
      ...
      },
      {
        ...
        "shots": [
          {
            ...
            "desc": "<strong>park 是 OSM 核实的停车场（way 244888128，44.76981, −109.42476）；view 是命名的 “Sunlight Bridge Overlook” 节点（44.77035, −109.42530），位于独立人行道（way 244888120，131 米）的中点。停车到桥中央约 120 米。</strong><strong>最佳时段 11:30–14:30，理由是几何而不是审美：9/24 太阳在 11:00 高度 36°、13:10 过中天高度 44.6°、15:00 降到 38°。峡谷窄而深，只有太阳高度超过约 35° 时才有直射光落到谷壁下部与水面。</strong><strong>08:00 或 18:00 来这里，你会得到一条纯黑的缝，什么细节都没有——这一点和垭口正好相反，也和本子地区其他所有机位相反。</strong><strong>如果你的行程是「清晨 Dead Indian → 中午 Sunlight Bridge」，那顺序恰好是对的。</strong>焦段：<strong>16–24mm 竖幅从人行道向下拍，把桥的栏杆或桥体边缘留在画面顶端做前景，这样才有「站在多高的地方」的信息</strong>；<strong>24–70mm 顺着峡谷轴线（西南上游／东北下游）拍进去，让岩缝的两侧岩壁形成收敛线</strong>；<strong>70–200mm 单独压谷底的水与光斑。</strong><strong>器材注意三条：（一）桥面会因过车而震动，慢门必须等车过完；（二）峡谷是风道，请不要把相机伸出栏杆外；（三）CPL 在这里很有用，用来压掉水面反光看清谷底。</strong><strong>把相机带或腕带扣好——掉下去就是永久损失，而且底下没有任何可能取回的路径。</strong>"
          },
          {
            "name": "桥北端与停车场一侧 —— 拍桥本身",
            "park": [
        ...
        "access": {
          ...
          "ticket": "<strong>免费。</strong>桥上人行道、停车与桥南端的厕所全部免费。Sunlight Creek Picnic Site 官方页 Fee 栏写的是 “No fee”，<strong>但同一页的状态标签是 “Site Closed”，所以那里 9 月下旬能不能用是另一回事（见 hours）。</strong>不进入 Yellowstone，因此不需要国家公园门票",
          "hours": "<strong>公路开放期内 24 小时可进入，无闸门。</strong><strong>桥所在的 WY-296 路段全年通车，不随 US-212 在 10 月 12 日关闭</strong>（NPS 原文 “Open year-round from WY-120 to Pilot Creek Parking Lot”，Sunlight Bridge 在这一段内），<strong>因此 9 月 22–29 日确定开放。</strong><strong>Sunlight Creek Picnic Site：2026-09-05 复核 Shoshone National Forest 官方页，页面状态标签就是 “Site Closed”，“Operational Hours” 一栏写的是 “Sunlight Creek Picnic area is open pending road conditions”，页面 Last updated 2025 年 11 月 13 日。</strong><strong>所以请直接按「野餐区与它的 vault toilet 都不可用」规划，不要把它算成厕所点</strong>（唯一确定的厕所是桥南端那个，44.76973, −109.42442）。<strong>官方这句 “pending road conditions” 没有给日期，也没有说支路封不封——碎石支路本身是公共道路，2026 年是否设了路障未能从官方渠道确认，请以现场标示为准。</strong>要确认就打 Clarks Fork Ranger District <strong>(307) 527-6921</strong>。<strong>桥上人行道全年不关（属公路结构的一部分），所以这个景点的主机位不受影响。</strong>",
      ...
      },
      {
        ...
        "access": {
          ...
          "ticket": "<strong>免费。</strong>观景台、停车、厕所均无收费。<strong>WY-296 全线免费，且不进入 Yellowstone，所以不需要国家公园门票——这一点在 Beartooth 封路那天很有用</strong>",
          "hours": "<strong>公路开放期内 24 小时可进入，无闸门、无门禁。</strong><strong>本观景台所在的 WY-296 路段其实全年通车，并不随 US-212 在 10 月 12 日一起关。</strong>NPS 原文：<strong>“Open year-round from WY-120 to Pilot Creek Parking Lot”</strong>，<strong>Dead Indian Pass 就在这一段之内</strong>；10/12 关的是 US-212 全线，以及 WY-296／US-212 路口往 Cooke City 方向那 9 英里（该 9 英里段的通车期为 mid-May 至 early November）。<strong>因此 9 月 22–29 日本点位确定开放，而且即使 Beartooth 因雪封了，这里通常还在——这正是它作为备选方案的价值。</strong><strong>与 Beartooth Highway 不同，WY-296 最高点只有 8,048 英尺，因季节性降雪临时封路的概率明显低得多</strong>（<strong>具体概率无官方统计，此处为基于海拔差的推断</strong>）。<strong>实时状态查 Wyoming DOT 路况（wyoroad.info），这与 Beartooth 的 Montana DOT 是两套系统，请分别查。</strong>",
